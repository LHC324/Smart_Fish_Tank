...
__attribute__((aligned(32))) u8 mem2base[MEM2_MAX_SIZE]; __attribute__((at(0X10000000)));					//内部CCM内存池
__attribute__((aligned(32))) u8 mem3base[MEM3_MAX_SIZE] __attribute__((at(0X68000000)));					//外部SRAM内存池
