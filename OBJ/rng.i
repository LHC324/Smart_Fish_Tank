...
u8 RNG_Init(void){
    ...
    RNG_Handler.Instance=((RNG_TypeDef *) ((0x40000000UL + 0x10000000UL) + 0x60800UL));
    HAL_RNG_Init(&RNG_Handler);
    while((((&RNG_Handler)->Instance ->SR & ((0x1UL << (0U)))) == ((0x1UL << (0U))))==RESET&&retry<10000){
        retry++;
        delay_us(10);
    }
