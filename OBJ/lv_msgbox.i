#line 1 "..\\GUI\\lvgl_src\\lv_widgets\\lv_msgbox.c"
...
#line 10 "..\\GUI\\lvgl_src\\lv_widgets\\lv_msgbox.c"


#line 13 "..\\GUI\\lvgl_src\\lv_widgets\\lv_msgbox.c"
#line 14 "..\\GUI\\lvgl_src\\lv_widgets\\lv_msgbox.c"
...
#line 15 "..\\GUI\\lvgl_src\\lv_widgets\\lv_msgbox.c"
...
#line 16 "..\\GUI\\lvgl_src\\lv_widgets\\lv_msgbox.c"
#line 17 "..\\GUI\\lvgl_src\\lv_widgets\\lv_msgbox.c"
#line 18 "..\\GUI\\lvgl_src\\lv_widgets\\lv_msgbox.c"
...
#line 32 "..\\GUI\\lvgl_src\\lv_widgets\\lv_msgbox.c"
...
lv_obj_t * lv_msgbox_create(lv_obj_t * par, const lv_obj_t * copy)
{
    ...
    do { if(!((lv_debug_check_null(mbox)))) { ; lv_debug_log_error("Out of memory", (uint64_t)((uintptr_t)mbox)); while(1); } } while(0);;
    if(mbox == 0) return 0;

    if(ancestor_signal == 0) ancestor_signal = lv_obj_get_signal_cb(mbox);
    ...
    if(copy == 0) {
        ext->text = lv_label_create(mbox, 0);
        ...
        if(lv_disp_get_size_category(0) <= LV_DISP_SIZE_SMALL) {
            lv_obj_set_width(mbox, fit_w);
        }
        else {
            lv_obj_set_width(mbox, ((fit_w) < ((400 == 0 ? 0 :(((( lv_disp_get_dpi(0) * (400) + 80) / 160)) > (1) ? ((( lv_disp_get_dpi(0) * (400) + 80) / 160)) : (1)))) ? (fit_w) : ((400 == 0 ? 0 :(((( lv_disp_get_dpi(0) * (400) + 80) / 160)) > (1) ? ((( lv_disp_get_dpi(0) * (400) + 80) / 160)) : (1))))));
        }
        lv_obj_align(mbox, 0, LV_ALIGN_CENTER, 0, 0);
        ...
        lv_obj_refresh_style(mbox, LV_OBJ_PART_ALL, 0xFF);
    }
...
{
    do { if(!((lv_debug_check_null(mbox)))) { ; lv_debug_log_error("NULL pointer", (uint64_t)((uintptr_t)mbox)); while(1); } } while(0);;
    do { if(!((lv_debug_check_null(btn_map)))) { ; lv_debug_log_error("NULL pointer", (uint64_t)((uintptr_t)btn_map)); while(1); } } while(0);;

    lv_msgbox_ext_t * ext = lv_obj_get_ext_attr(mbox);

     
    if(ext->btnm == 0) {
        ext->btnm = lv_btnmatrix_create(mbox, 0);
...
void lv_msgbox_start_auto_close(lv_obj_t * mbox, uint16_t delay)
{
    ...
    if(lv_msgbox_get_anim_time(mbox) != 0) {
        ...
        lv_anim_init(&a);
        lv_anim_set_var(&a, mbox);
        lv_anim_set_exec_cb(&a, (lv_anim_exec_xcb_t)0);
...
static lv_res_t lv_msgbox_signal(lv_obj_t * mbox, lv_signal_t sign, void * param)
{
    ...
    if(sign == LV_SIGNAL_GET_TYPE) return lv_obj_handle_get_type_signal(param, "lv_msgbox");
    ...
    if(sign == LV_SIGNAL_COORD_CHG) {
        ...
        if(ext->btnm) {
            ...
            if(btn_id != 0xFFFF) lv_event_send(mbox, LV_EVENT_VALUE_CHANGED, &btn_id);
        }
    }
    else if(
        ...
        if(sign == LV_SIGNAL_FOCUS) {
            ...
            if(indev_type == LV_INDEV_TYPE_ENCODER) {
                ...
                else lv_btnmatrix_set_focused_btn(ext->btnm, 0xFFFF);
            }
        }
...
static lv_style_list_t * lv_msgbox_get_style(lv_obj_t * mbox, uint8_t part)
{
    ...
    switch(part) {
        ...
        case LV_MSGBOX_PART_BTN_BG:
            style_dsc_p = ext->btnm ? lv_obj_get_style_list(ext->btnm, LV_BTNMATRIX_PART_BG) : 0;
            break;
        case LV_MSGBOX_PART_BTN:
            style_dsc_p = ext->btnm ? lv_obj_get_style_list(ext->btnm, LV_BTNMATRIX_PART_BTN) : 0;
            break;
        default:
            style_dsc_p = 0;
    }
