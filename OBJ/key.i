...
{
    null_founction("KEY1 PRESS ,Production Mode\n");
...
{
    null_founction("KEY1 PRESS LONG ,Wifi Reset\n");
...
{
    null_founction("KEY2 PRESS ,Soft AP mode\n");
...
void key2LongPress(void)
{
    ...
    null_founction("KEY2 PRESS LONG ,AirLink mode\n");
...
void keyInit(void)
{
    singleKey[0] = keyInitOne(0, ((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL)), ((uint16_t)0x0010), key1ShortPress, key1LongPress);
    singleKey[1] = keyInitOne(0, ((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL)), ((uint16_t)0x0008), key2ShortPress, key2LongPress);
...
void KEY_Init(void){
    ...
    GPIO_Initure.Pin=((uint16_t)0x0001);            
    GPIO_Initure.Mode=0x00000000U;      
    GPIO_Initure.Pull=0x00000002U;        
	...
	GPIO_Initure.Pin=((uint16_t)0x0004)|((uint16_t)0x0008)|((uint16_t)0x0010); 
    GPIO_Initure.Mode=0x00000000U;      
