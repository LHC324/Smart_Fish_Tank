...
#line 4 "..\\HARDWARE\\TOUCH\\touch.c"
#line 5 "..\\HARDWARE\\TOUCH\\touch.c"
...
{  
	...
	{ 	  
		if(num&0x80)*((volatile unsigned long *)((((((0x40000000UL + 0x00020000UL) + 0x0400UL)+20) & 0xF0000000)+0x2000000+(((((0x40000000UL + 0x00020000UL) + 0x0400UL)+20) &0xFFFFF)<<5)+(15<<2))))=1;  
		else *((volatile unsigned long *)((((((0x40000000UL + 0x00020000UL) + 0x0400UL)+20) & 0xF0000000)+0x2000000+(((((0x40000000UL + 0x00020000UL) + 0x0400UL)+20) &0xFFFFF)<<5)+(15<<2))))=0;   
		num<<=1;    
		*((volatile unsigned long *)((((((0x40000000UL + 0x00020000UL) + 0x0400UL)+20) & 0xF0000000)+0x2000000+(((((0x40000000UL + 0x00020000UL) + 0x0400UL)+20) &0xFFFFF)<<5)+(13<<2))))=0; 
		delay_us(1);
		*((volatile unsigned long *)((((((0x40000000UL + 0x00020000UL) + 0x0400UL)+20) & 0xF0000000)+0x2000000+(((((0x40000000UL + 0x00020000UL) + 0x0400UL)+20) &0xFFFFF)<<5)+(13<<2))))=1;		
	}		 			    
} 		 
...
{ 	 
	...
	*((volatile unsigned long *)((((((0x40000000UL + 0x00020000UL) + 0x0400UL)+20) & 0xF0000000)+0x2000000+(((((0x40000000UL + 0x00020000UL) + 0x0400UL)+20) &0xFFFFF)<<5)+(12<<2))))=0; 		
	TP_Write_Byte(CMD);
	delay_us(6);
	*((volatile unsigned long *)((((((0x40000000UL + 0x00020000UL) + 0x0400UL)+20) & 0xF0000000)+0x2000000+(((((0x40000000UL + 0x00020000UL) + 0x0400UL)+20) &0xFFFFF)<<5)+(13<<2))))=0; 	     	    
	delay_us(1);    	   
	...
	*((volatile unsigned long *)((((((0x40000000UL + 0x00020000UL) + 0x0400UL)+20) & 0xF0000000)+0x2000000+(((((0x40000000UL + 0x00020000UL) + 0x0400UL)+20) &0xFFFFF)<<5)+(13<<2))))=0; 	     	    
	...
	{ 				  
		...
		*((volatile unsigned long *)((((((0x40000000UL + 0x00020000UL) + 0x0400UL)+20) & 0xF0000000)+0x2000000+(((((0x40000000UL + 0x00020000UL) + 0x0400UL)+20) &0xFFFFF)<<5)+(13<<2))))=0;	
		delay_us(1);    
 		*((volatile unsigned long *)((((((0x40000000UL + 0x00020000UL) + 0x0400UL)+20) & 0xF0000000)+0x2000000+(((((0x40000000UL + 0x00020000UL) + 0x0400UL)+20) &0xFFFFF)<<5)+(13<<2))))=1;
 		if(*((volatile unsigned long *)((((((0x40000000UL + 0x00020000UL) + 0x0400UL)+16) & 0xF0000000)+0x2000000+(((((0x40000000UL + 0x00020000UL) + 0x0400UL)+16) &0xFFFFF)<<5)+(14<<2)))))Num++; 		 
	}  	
	Num>>=4;   	
	*((volatile unsigned long *)((((((0x40000000UL + 0x00020000UL) + 0x0400UL)+20) & 0xF0000000)+0x2000000+(((((0x40000000UL + 0x00020000UL) + 0x0400UL)+20) &0xFFFFF)<<5)+(12<<2))))=1;		
	return(Num);   
}
...
u8 TP_Scan(u8 tp)
{			   
	if(*((volatile unsigned long *)((((((0x40000000UL + 0x00020000UL) + 0x0800UL)+16) & 0xF0000000)+0x2000000+(((((0x40000000UL + 0x00020000UL) + 0x0800UL)+16) &0xFFFFF)<<5)+(5<<2))))==0)
	{
		...
		if((tp_dev.sta&0x80)==0)
		{		 
			tp_dev.sta=0x80|0x40;
...
void TP_Save_Adjdata(void)
{
    ...
    AT24CXX_WriteLenByte(40,temp,4);   
	temp=tp_dev.yfac*100000000;
    AT24CXX_WriteLenByte(40+4,temp,4);
	
    AT24CXX_WriteLenByte(40+8,tp_dev.xoff,2);		    
	
	AT24CXX_WriteLenByte(40+10,tp_dev.yoff,2);	
	
	AT24CXX_WriteOneByte(40+12,tp_dev.touchtype);	
	temp=0X0A;
	AT24CXX_WriteOneByte(40+13,temp); 
}
...
{					  
	s32 tempfac;
	tempfac=AT24CXX_ReadOneByte(40+13);
	if(tempfac==0X0A)
	{    												 
		tempfac=AT24CXX_ReadLenByte(40,4);		   
		tp_dev.xfac=(float)tempfac/100000000;
		tempfac=AT24CXX_ReadLenByte(40+4,4);			          
		tp_dev.yfac=(float)tempfac/100000000;
	    
		tp_dev.xoff=AT24CXX_ReadLenByte(40+8,2);			   	  
 	    
		tp_dev.yoff=AT24CXX_ReadLenByte(40+10,2);				 	  
 		tp_dev.touchtype=AT24CXX_ReadOneByte(40+12);
		if(tp_dev.touchtype)
		{
			CMD_RDX=0X90;
			CMD_RDY=0XD0;	 
		...
		{	
			...
			{			   
				case 1:						 
					...
					TP_Drow_Touch_Point(lcddev.width-20,20,0xF800);	
					break;
				case 2:
 					TP_Drow_Touch_Point(lcddev.width-20,20,0xFFFF);	
					TP_Drow_Touch_Point(20,lcddev.height-20,0xF800);	
					break;
				case 3:
 					TP_Drow_Touch_Point(20,lcddev.height-20,0xFFFF);			
 					TP_Drow_Touch_Point(lcddev.width-20,lcddev.height-20,0xF800);	
					break;
				case 4:	 
					...
					{
						cnt=0;
 				    	TP_Drow_Touch_Point(lcddev.width-20,lcddev.height-20,0xFFFF);	
   	 					TP_Drow_Touch_Point(20,20,0xF800);								
...
u8 TP_Init(void)
{
...

	{
		...
		GPIO_Initure.Pin=((uint16_t)0x4000);	
		GPIO_Initure.Mode=0x00000000U;  	
		...
		GPIO_Initure.Pin=((uint16_t)0x1000)|((uint16_t)0x2000)|((uint16_t)0x8000); 
