#line 1 "..\\GUI\\lvgl_src\\lv_misc\\lv_anim.c"
...
#line 1 "..\\GUI\\lvgl_src\\lv_misc\\lv_anim.h"
...
#line 17 "..\\GUI\\lvgl_src\\lv_misc\\lv_anim.h"

#line 19 "..\\GUI\\lvgl_src\\lv_misc\\lv_anim.h"
...
#line 20 "..\\GUI\\lvgl_src\\lv_misc\\lv_anim.h"
...
#line 21 "..\\GUI\\lvgl_src\\lv_misc\\lv_anim.h"
...
#line 22 "..\\GUI\\lvgl_src\\lv_misc\\lv_anim.h"
...
#line 10 "..\\GUI\\lvgl_src\\lv_misc\\lv_anim.c"

#line 13 "..\\GUI\\lvgl_src\\lv_misc\\lv_anim.c"
#line 14 "..\\GUI\\lvgl_src\\lv_misc\\lv_anim.c"
...
#line 15 "..\\GUI\\lvgl_src\\lv_misc\\lv_anim.c"
...
#line 16 "..\\GUI\\lvgl_src\\lv_misc\\lv_anim.c"
...
#line 17 "..\\GUI\\lvgl_src\\lv_misc\\lv_anim.c"
...
#line 18 "..\\GUI\\lvgl_src\\lv_misc\\lv_anim.c"
...
#line 19 "..\\GUI\\lvgl_src\\lv_misc\\lv_anim.c"
...
static _Bool anim_ready_handler(lv_anim_t * a);



 
static uint32_t last_task_run;
static _Bool anim_list_changed;
...
void _lv_anim_core_init(void)
{
    _lv_ll_init(&_lv_anim_ll, sizeof(lv_anim_t));
    last_task_run = lv_tick_get();
    _lv_anim_task = lv_task_create(anim_task, 30, LV_TASK_PRIO_HIGH, 0);
...
void lv_anim_start(lv_anim_t * a)
{
    ...
    if(a->exec_cb != 0) lv_anim_del(a->var, a->exec_cb);  

     
    if(_lv_ll_is_empty(&_lv_anim_ll)) {
        last_task_run = lv_tick_get() - 1;
    }

     
    lv_anim_t * new_anim = _lv_ll_ins_head(&_lv_anim_ll);
    do { if(!((lv_debug_check_null(new_anim)))) { ; lv_debug_log_error("Out of memory", (uint64_t)((uintptr_t)new_anim)); while(1); } } while(0);;
    if(new_anim == 0) return;
...
_Bool lv_anim_del(void * var, lv_anim_exec_xcb_t exec_cb)
{
    ...
    lv_anim_t * a_next;
    _Bool del = 0;
    a        = _lv_ll_get_head(&_lv_anim_ll);
    while(a != 0) {
         
        a_next = _lv_ll_get_next(&_lv_anim_ll, a);

        if(a->var == var && (a->exec_cb == exec_cb || exec_cb == 0)) {
            _lv_ll_remove(&_lv_anim_ll, a);
            lv_mem_free(a);
            anim_mark_list_change(); 
...
{
    lv_anim_t * a;
    for(a = _lv_ll_get_head(&_lv_anim_ll); a != 0; a = _lv_ll_get_next(&_lv_anim_ll, a)) {
...
uint16_t lv_anim_count_running(void)
{
    uint16_t cnt = 0;
    lv_anim_t * a;
    for(a = _lv_ll_get_head(&_lv_anim_ll); a != 0; a = _lv_ll_get_next(&_lv_anim_ll, a)) cnt++;
...
uint16_t lv_anim_speed_to_time(uint16_t speed, lv_anim_value_t start, lv_anim_value_t end)
{
    int32_t d     = (((int32_t)start - end) > 0 ? ((int32_t)start - end) : (-((int32_t)start - end)));
...
lv_anim_value_t lv_anim_path_linear(const lv_anim_path_t * path, const lv_anim_t * a)
{
    ...
    if(a->time == a->act_time) {
        ...
        step = ((int32_t)a->act_time * 1024) / a->time;
    }
...
static void anim_task(lv_task_t * param)
{
    ...
    while(a != 0) {
        ...
        if(anim_list_changed)
            ...
            a = _lv_ll_get_next(&_lv_anim_ll, a);
    }
...
static _Bool anim_ready_handler(lv_anim_t * a)
{
    ...
    if(a->playback_now == 0 && a->repeat_cnt > 0 && a->repeat_cnt != 0xFFFF) {
        a->repeat_cnt--;
    }
    ...
    if(a->repeat_cnt == 0 && ((a->playback_time == 0) || (a->playback_time && a->playback_now == 1))) {
        ...
        if(a_tmp.ready_cb != 0) a_tmp.ready_cb(&a_tmp);
    }
...
{
    anim_list_changed = 1;
    if(_lv_ll_get_head(&_lv_anim_ll) == 0)
        lv_task_set_prio(_lv_anim_task, LV_TASK_PRIO_OFF);
    else
        lv_task_set_prio(_lv_anim_task, LV_TASK_PRIO_HIGH);
}
