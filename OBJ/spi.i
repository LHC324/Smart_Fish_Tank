...
void SPI_Init(void)
{
	...
	SPI_Handler.Instance=((SPI_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x3000UL));                         



    SPI_Handler.Init.Mode=((0x1UL << (2U)) | (0x1UL << (8U)));             
    SPI_Handler.Init.Direction=(0x00000000U);   
    SPI_Handler.Init.DataSize=(0x00000000U);       
    SPI_Handler.Init.CLKPolarity=(0x1UL << (1U));    
    SPI_Handler.Init.CLKPhase=(0x1UL << (0U));         
    SPI_Handler.Init.NSS=(0x1UL << (9U));                 
    SPI_Handler.Init.BaudRatePrescaler=((0x4UL << (3U)) | (0x2UL << (3U)) | (0x1UL << (3U)));
    SPI_Handler.Init.FirstBit=(0x00000000U);        
    SPI_Handler.Init.TIMode=(0x00000000U);        
    SPI_Handler.Init.CRCCalculation=(0x00000000U);
    SPI_Handler.Init.CRCPolynomial=7;                  
    HAL_SPI_Init(&SPI_Handler);
    
    (((&SPI_Handler)->Instance ->CR1) |= ((0x1UL << (6U))));                    
...
void HAL_SPI_MspInit(SPI_HandleTypeDef *hspi)
{
    ...
    GPIO_Initure.Pin=((uint16_t)0x0008)|((uint16_t)0x0010)|((uint16_t)0x0020);
    GPIO_Initure.Mode=0x00000002U;              
    GPIO_Initure.Pull=0x00000001U;                  
    GPIO_Initure.Speed=0x00000002U;             
    GPIO_Initure.Alternate=((uint8_t)0x05);           
#line 60 "..\\HARDWARE\\SPI\\spi.c"
