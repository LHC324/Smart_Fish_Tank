...
HAL_StatusTypeDef RTC_Set_Time(u8 hour,u8 min,u8 sec,u8 ampm)
{
	...
	RTC_TimeStructure.DayLightSaving=0x00000000U;
    RTC_TimeStructure.StoreOperation=0x00000000U;
	return HAL_RTC_SetTime(&RTC_Handler,&RTC_TimeStructure,0x00000000U);	
}
...
HAL_StatusTypeDef RTC_Set_Date(u8 year,u8 month,u8 date,u8 week)
{
	...
	return HAL_RTC_SetDate(&RTC_Handler,&RTC_DateStructure,0x00000000U);
}
...
{      
	...
	RTC_Handler.Instance=((RTC_TypeDef *) (0x40000000UL + 0x2800UL));
    RTC_Handler.Init.HourFormat=0x00000000U;
    RTC_Handler.Init.AsynchPrediv=0X7F;           
    RTC_Handler.Init.SynchPrediv=0XFF;            
    RTC_Handler.Init.OutPut=0x00000000U;     
    RTC_Handler.Init.OutPutPolarity=0x00000000U;
    RTC_Handler.Init.OutPutType=0x00000000U;
    if(HAL_RTC_Init(&RTC_Handler)!=HAL_OK) return 2;
      
    if(HAL_RTCEx_BKUPRead(&RTC_Handler,0x00000000U)!=0X5050)
    { 
        RTC_Set_Time(7,30,0,((uint8_t)0x40));	        
		RTC_Set_Date(20,12,6,6);		                    
        HAL_RTCEx_BKUPWrite(&RTC_Handler,0x00000000U,0X5050);
    }
    return 0;
}
...
void HAL_RTC_MspInit(RTC_HandleTypeDef* hrtc)
{
    ...
    RCC_OscInitStruct.OscillatorType=0x00000004U;
...
{ 
    ...
    RTC_AlarmSturuct.AlarmTime.TimeFormat=((uint8_t)0x00);
    
    RTC_AlarmSturuct.AlarmMask=0x00000000U;
    RTC_AlarmSturuct.AlarmSubSecondMask=0x0F000000U;
    RTC_AlarmSturuct.AlarmDateWeekDaySel=0x40000000U;
    RTC_AlarmSturuct.AlarmDateWeekDay=week; 
    RTC_AlarmSturuct.Alarm=(0x1UL << (8U));     
    HAL_RTC_SetAlarm_IT(&RTC_Handler,&RTC_AlarmSturuct,0x00000000U);
    
    HAL_NVIC_SetPriority(RTC_Alarm_IRQn,3,0x00); 
...
void RTC_Set_WakeUp(u32 wksel,u16 cnt)
{ 
    ((&RTC_Handler)->Instance ->ISR) = (~((0x00000400U) | (0x1UL << (7U)))|((&RTC_Handler)->Instance ->ISR & (0x1UL << (7U))));
	
	HAL_RTCEx_SetWakeUpTimer_IT(&RTC_Handler,cnt,wksel);            
	
    HAL_NVIC_SetPriority(RTC_WKUP_IRQn,4,0x00); 
