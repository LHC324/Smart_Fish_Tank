#line 1 "..\\GUI\\lvgl_src\\lv_widgets\\lv_line.c"
...
#line 10 "..\\GUI\\lvgl_src\\lv_widgets\\lv_line.c"

#line 13 "..\\GUI\\lvgl_src\\lv_widgets\\lv_line.c"
...
#line 14 "..\\GUI\\lvgl_src\\lv_widgets\\lv_line.c"
#line 15 "..\\GUI\\lvgl_src\\lv_widgets\\lv_line.c"
...
#line 16 "..\\GUI\\lvgl_src\\lv_widgets\\lv_line.c"
#line 17 "..\\GUI\\lvgl_src\\lv_widgets\\lv_line.c"
#line 18 "..\\GUI\\lvgl_src\\lv_widgets\\lv_line.c"
#line 19 "..\\GUI\\lvgl_src\\lv_widgets\\lv_line.c"
...
lv_obj_t * lv_line_create(lv_obj_t * par, const lv_obj_t * copy)
{
    ...
    do { if(!((lv_debug_check_null(line)))) { ; lv_debug_log_error("Out of memory", (uint64_t)((uintptr_t)line)); while(1); } } while(0);;
    if(line == 0) return 0;

    if(ancestor_signal == 0) ancestor_signal = lv_obj_get_signal_cb(line);
    ...
    if(copy == 0) {
        lv_obj_set_size(line, 60,
                        60);           

        lv_obj_set_click(line, 0);
        ...
        lv_obj_refresh_style(line, LV_OBJ_PART_ALL, 0xFF);
    }
...
void lv_line_set_points(lv_obj_t * line, const lv_point_t point_a[], uint16_t point_num)
{
    do { if(!((lv_debug_check_null(line)))) { ; lv_debug_log_error("NULL pointer", (uint64_t)((uintptr_t)line)); while(1); } } while(0);;
    ...
    if(point_num > 0 && ext->auto_size != 0) {
        uint16_t i;
        lv_coord_t xmax = (-((lv_coord_t)((uint32_t)((uint32_t)1 << (8 * sizeof(lv_coord_t) - 1)) - 1000)));
        lv_coord_t ymax = (-((lv_coord_t)((uint32_t)((uint32_t)1 << (8 * sizeof(lv_coord_t) - 1)) - 1000)));
        for(i = 0; i < point_num; i++) {
            xmax = ((point_a[i]. x) > (xmax) ? (point_a[i]. x) : (xmax));
            ymax = ((point_a[i]. y) > (ymax) ? (point_a[i]. y) : (ymax));
        }
...
static lv_design_res_t lv_line_design(lv_obj_t * line, const lv_area_t * clip_area, lv_design_mode_t mode)
{
    ...
    if(mode == LV_DESIGN_COVER_CHK)
        ...
        if(ext->point_num == 0 || ext->point_array == 0) return 0;
...
static lv_res_t lv_line_signal(lv_obj_t * line, lv_signal_t sign, void * param)
{
    ...
    if(sign == LV_SIGNAL_GET_TYPE) return lv_obj_handle_get_type_signal(param, "lv_line");
