...
__attribute__((aligned(32))) u8 mem1base[6*1024];													
__attribute__((aligned(32))) u8 mem2base[1 *1024]; __attribute__((at(0X10000000)));					
__attribute__((aligned(32))) u8 mem3base[960 *1024] __attribute__((at(0X68000000)));					


u16 mem1mapbase[6*1024/32];													
u16 mem2mapbase[1 *1024/32] __attribute__((at(0X10000000+1 *1024)));	
u16 mem3mapbase[960 *1024/32] __attribute__((at(0X68000000+960 *1024)));	


const u32 memtblsize[3]={6*1024/32,1 *1024/32,960 *1024/32};	
const u32 memblksize[3]={32,32,32};					
const u32 memsize[3]={6*1024,1 *1024,960 *1024};							
