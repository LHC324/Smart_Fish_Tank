#line 1 "..\\GUI\\lvgl_src\\lv_widgets\\lv_tileview.c"
...
#line 10 "..\\GUI\\lvgl_src\\lv_widgets\\lv_tileview.c"


#line 13 "..\\GUI\\lvgl_src\\lv_widgets\\lv_tileview.c"
#line 14 "..\\GUI\\lvgl_src\\lv_widgets\\lv_tileview.c"
#line 15 "..\\GUI\\lvgl_src\\lv_widgets\\lv_tileview.c"
#line 16 "..\\GUI\\lvgl_src\\lv_widgets\\lv_tileview.c"
...
#line 17 "..\\GUI\\lvgl_src\\lv_widgets\\lv_tileview.c"
...
#line 31 "..\\GUI\\lvgl_src\\lv_widgets\\lv_tileview.c"
...
static _Bool set_valid_drag_dirs(lv_obj_t * tileview);
...
lv_obj_t * lv_tileview_create(lv_obj_t * par, const lv_obj_t * copy)
{
    ...
    do { if(!((lv_debug_check_null(new_tileview)))) { ; lv_debug_log_error("Out of memory", (uint64_t)((uintptr_t)new_tileview)); while(1); } } while(0);;
    if(new_tileview == 0) return 0;
    ...
    if(ancestor_signal == 0) ancestor_signal = lv_obj_get_signal_cb(new_tileview);
    if(ancestor_scrl_signal == 0) ancestor_scrl_signal = lv_obj_get_signal_cb(lv_page_get_scrollable(new_tileview));
    if(ancestor_design == 0) ancestor_design = lv_obj_get_design_cb(new_tileview);
    ...
    if(copy == 0) {
        ...
        lv_obj_set_drag_throw(lv_page_get_scrollable(new_tileview), 1);
        ...
        lv_obj_refresh_style(new_tileview, LV_OBJ_PART_ALL, 0xFF);
    }
...
{
    ((void) tileview);
    do { if(!((lv_debug_check_null(tileview)))) { ; lv_debug_log_error("NULL pointer", (uint64_t)((uintptr_t)tileview)); while(1); } } while(0);;
    do { if(!((lv_debug_check_null(tileview)))) { ; lv_debug_log_error("NULL pointer", (uint64_t)((uintptr_t)tileview)); while(1); } } while(0);;

    lv_page_glue_obj(element, 1);
}
...
{
    do { if(!((lv_debug_check_null(tileview)))) { ; lv_debug_log_error("NULL pointer", (uint64_t)((uintptr_t)tileview)); while(1); } } while(0);;
    do { if(!((lv_debug_check_null(valid_pos)))) { ; lv_debug_log_error("NULL pointer", (uint64_t)((uintptr_t)valid_pos)); while(1); } } while(0);;
...
static lv_res_t lv_tileview_signal(lv_obj_t * tileview, lv_signal_t sign, void * param)
{
    ...
    if(sign == LV_SIGNAL_GET_TYPE) return lv_obj_handle_get_type_signal(param, "lv_tileview");
...
static void drag_end_handler(lv_obj_t * tileview)
{
    ...
    lv_tileview_set_tile_act(tileview, ext->act_id.x + x_move, ext->act_id.y + y_move, 1);
}
