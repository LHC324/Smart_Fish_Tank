#line 1 "..\\GUI\\lvgl_src\\lv_widgets\\lv_spinner.c"
...
#line 10 "..\\GUI\\lvgl_src\\lv_widgets\\lv_spinner.c"


#line 13 "..\\GUI\\lvgl_src\\lv_widgets\\lv_spinner.c"
#line 14 "..\\GUI\\lvgl_src\\lv_widgets\\lv_spinner.c"
#line 15 "..\\GUI\\lvgl_src\\lv_widgets\\lv_spinner.c"
...
#line 16 "..\\GUI\\lvgl_src\\lv_widgets\\lv_spinner.c"
...
#line 17 "..\\GUI\\lvgl_src\\lv_widgets\\lv_spinner.c"
...
lv_obj_t * lv_spinner_create(lv_obj_t * par, const lv_obj_t * copy)
{
    ...
    do { if(!((lv_debug_check_null(spinner)))) { ; lv_debug_log_error("Out of memory", (uint64_t)((uintptr_t)spinner)); while(1); } } while(0);;
    if(spinner == 0) return 0;
    ...
    if(ancestor_signal == 0) ancestor_signal = lv_obj_get_signal_cb(spinner);
    if(ancestor_design == 0) ancestor_design = lv_obj_get_design_cb(spinner);

     
    ext->arc_length = 60;
    ext->anim_type  = LV_SPINNER_TYPE_SPINNING_ARC;
    ...
    if(copy == 0) {
        ...
        lv_obj_refresh_style(spinner, LV_OBJ_PART_ALL, 0xFF);
    }
...
void lv_spinner_set_arc_length(lv_obj_t * spinner, lv_anim_value_t deg)
{
    do { if(!((lv_debug_check_null(spinner)))) { ; lv_debug_log_error("NULL pointer", (uint64_t)((uintptr_t)spinner)); while(1); } } while(0);;
...
static lv_res_t lv_spinner_signal(lv_obj_t * spinner, lv_signal_t sign, void * param)
{
    ...
    if(sign == LV_SIGNAL_GET_TYPE) return lv_obj_handle_get_type_signal(param, "lv_spinner");
