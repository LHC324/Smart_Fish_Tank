...
void Stm32_Clock_Init(u32 plln,u32 pllm,u32 pllp,u32 pllq)
{
    ...
    RCC_OscInitStructure.OscillatorType=0x00000001U;    
    RCC_OscInitStructure.HSEState=(0x1UL << (16U));                      
    RCC_OscInitStructure.PLL.PLLState=((uint8_t)0x02);                  
    RCC_OscInitStructure.PLL.PLLSource=(0x1UL << (22U));
    ...
    RCC_ClkInitStructure.ClockType=(0x00000001U|0x00000002U|0x00000004U|0x00000008U);
    RCC_ClkInitStructure.SYSCLKSource=0x00000002U;
    RCC_ClkInitStructure.AHBCLKDivider=0x00000000U;
    RCC_ClkInitStructure.APB1CLKDivider=0x00001400U; 
    RCC_ClkInitStructure.APB2CLKDivider=0x00001000U; 
    ret=HAL_RCC_ClockConfig(&RCC_ClkInitStructure,0x00000005U);
