...
UART_HandleTypeDef UART1_Handler,UART3_Handler; 
DMA_HandleTypeDef hdma_usart1_rx;
DMA_HandleTypeDef hdma_usart1_tx;
DMA_HandleTypeDef hdma_usart3_rx;
DMA_HandleTypeDef hdma_usart3_tx;

__attribute__((aligned(8))) u8 USART_DmaTxBuf[256];	
...
__attribute__((aligned(8))) u8 USART3_TX_BUF[256];
...
volatile uint8_t UART3IDLE_RxSize = 0;     
volatile uint8_t UART3IDLE_RxOverFlag = 0; 
...
void Usart1_DmaPrintf(const char *format,...)
{
   ...
   while((((&UART1_Handler)->Instance ->SR & (((uint32_t)(0x1UL << (6U))))) == (((uint32_t)(0x1UL << (6U))))) == RESET){} 
}
#line 123 "..\\SYSTEM\\usart\\usart.c"



void uart1_init(u32 bound){
	UART1_Handler.Instance=((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1000UL));					    
	...
	UART1_Handler.Init.Mode=((uint32_t)((0x1UL << (3U)) | (0x1UL << (2U))));		    
	UART1_Handler.Init.OverSampling = 0x00000000U; 
...
void usart3_init(u32 bound){ 
	UART3_Handler.Instance=((USART_TypeDef *) (0x40000000UL + 0x4800UL));					    
	UART3_Handler.Init.BaudRate=bound;				    
	UART3_Handler.Init.WordLength=0x00000000U;   
	UART3_Handler.Init.StopBits=0x00000000U;	    
	UART3_Handler.Init.Parity=0x00000000U;		    
	UART3_Handler.Init.HwFlowCtl=0x00000000U;   
	UART3_Handler.Init.Mode=((uint32_t)((0x1UL << (3U)) | (0x1UL << (2U))));		    
	UART3_Handler.Init.OverSampling = 0x00000000U; 
	HAL_UART_Init(&UART3_Handler);					    
	
	((((((uint32_t)(1U << 28U | (0x1UL << (4U))))) >> 28U) == 1U)? ((&UART3_Handler)->Instance ->CR1 |= ((((uint32_t)(1U << 28U | (0x1UL << (4U))))) & 0x0000FFFFU)): (((((uint32_t)(1U << 28U | (0x1UL << (4U))))) >> 28U) == 2U)? ((&UART3_Handler)->Instance ->CR2 |= ((((uint32_t)(1U << 28U | (0x1UL << (4U))))) & 0x0000FFFFU)): ((&UART3_Handler)->Instance ->CR3 |= ((((uint32_t)(1U << 28U | (0x1UL << (4U))))) & 0x0000FFFFU))); 
...
void HAL_UART_MspInit(UART_HandleTypeDef *huart){
	...
	if(huart->Instance==((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1000UL))){
		...
		GPIO_Initure.Pin = ((uint16_t)0x0200)|((uint16_t)0x0400);   
    ...
    hdma_usart1_tx.Init.Priority = ((uint32_t)(0x3UL << (16U)));
    ...
    do{ (huart)->hdmatx = &(hdma_usart1_tx); (hdma_usart1_tx). Parent = (huart); } while(0U);
		...
		GPIO_Initure.Pin = ((uint16_t)0x0400)|((uint16_t)0x0800);     
		GPIO_Initure.Mode = 0x00000002U;            
    ...
    hdma_usart3_rx.Init.Priority = ((uint32_t)(0x3UL << (16U)));
    ...
    do{ (&UART3_Handler)->hdmarx = &(hdma_usart3_rx); (hdma_usart3_rx). Parent = (&UART3_Handler); } while(0U);

     
    hdma_usart3_tx.Instance = ((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6000UL) + 0x058UL));
    hdma_usart3_tx.Init.Channel = 0x08000000U;
    hdma_usart3_tx.Init.Direction = ((uint32_t)(0x1UL << (6U)));
    hdma_usart3_tx.Init.PeriphInc = 0x00000000U;
    hdma_usart3_tx.Init.MemInc = ((uint32_t)(0x1UL << (10U)));
    ...
    hdma_usart3_tx.Init.Priority = ((uint32_t)(0x3UL << (16U)));
    hdma_usart3_tx.Init.FIFOMode = 0x00000000U;
    if (HAL_DMA_Init(&hdma_usart3_tx) != HAL_OK)
    {

    }

    do{ (&UART3_Handler)->hdmatx = &(hdma_usart3_tx); (hdma_usart3_tx). Parent = (&UART3_Handler); } while(0U);
...
void USART3_IRQHandler(void){
	...
	if(((((&UART3_Handler)->Instance ->SR & (((uint32_t)(0x1UL << (4U))))) == (((uint32_t)(0x1UL << (4U))))) != RESET)) 
	{ 
		do{ volatile uint32_t tmpreg = 0x00U; tmpreg = (&UART3_Handler)->Instance ->SR; tmpreg = (&UART3_Handler)->Instance ->DR; (void)tmpreg; } while(0U);		
		HAL_UART_DMAStop(&UART3_Handler); 				
		temp  =  ((&hdma_usart1_rx)->Instance ->NDTR);
		UART3IDLE_RxSize =  512 - temp; 
		UART3IDLE_RxOverFlag = 1;						
	 }
