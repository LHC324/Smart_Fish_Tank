#line 1 "..\\GUI\\lvgl_src\\lv_core\\lv_group.c"
...
#line 10 "..\\GUI\\lvgl_src\\lv_core\\lv_group.c"
#line 12 "..\\GUI\\lvgl_src\\lv_core\\lv_group.c"
#line 13 "..\\GUI\\lvgl_src\\lv_core\\lv_group.c"
#line 1 "..\\GUI\\lvgl_src\\lv_core\\../lv_themes/lv_theme.h"
...
#line 17 "..\\GUI\\lvgl_src\\lv_core\\../lv_themes/lv_theme.h"
#line 18 "..\\GUI\\lvgl_src\\lv_core\\../lv_themes/lv_theme.h"
#line 19 "..\\GUI\\lvgl_src\\lv_core\\../lv_themes/lv_theme.h"
...
#line 1 "..\\GUI\\lvgl_src\\lv_core\\../lv_themes/lv_theme_empty.h"
...
#line 17 "..\\GUI\\lvgl_src\\lv_core\\../lv_themes/lv_theme_empty.h"
...
#line 267 "..\\GUI\\lvgl_src\\lv_core\\../lv_themes/lv_theme.h"
#line 1 "..\\GUI\\lvgl_src\\lv_core\\../lv_themes/lv_theme_template.h"
...
#line 17 "..\\GUI\\lvgl_src\\lv_core\\../lv_themes/lv_theme_template.h"
...
#line 268 "..\\GUI\\lvgl_src\\lv_core\\../lv_themes/lv_theme.h"
#line 1 "..\\GUI\\lvgl_src\\lv_core\\../lv_themes/lv_theme_material.h"
...
#line 17 "..\\GUI\\lvgl_src\\lv_core\\../lv_themes/lv_theme_material.h"
...
#line 269 "..\\GUI\\lvgl_src\\lv_core\\../lv_themes/lv_theme.h"
#line 1 "..\\GUI\\lvgl_src\\lv_core\\../lv_themes/lv_theme_mono.h"
...
#line 17 "..\\GUI\\lvgl_src\\lv_core\\../lv_themes/lv_theme_mono.h"
...
#line 270 "..\\GUI\\lvgl_src\\lv_core\\../lv_themes/lv_theme.h"





#line 14 "..\\GUI\\lvgl_src\\lv_core\\lv_group.c"
#line 1 "..\\GUI\\lvgl_src\\lv_core\\../lv_misc/lv_gc.h"
...
#line 17 "..\\GUI\\lvgl_src\\lv_core\\../lv_misc/lv_gc.h"
#line 18 "..\\GUI\\lvgl_src\\lv_core\\../lv_misc/lv_gc.h"
#line 19 "..\\GUI\\lvgl_src\\lv_core\\../lv_misc/lv_gc.h"
#line 20 "..\\GUI\\lvgl_src\\lv_core\\../lv_misc/lv_gc.h"
#line 21 "..\\GUI\\lvgl_src\\lv_core\\../lv_misc/lv_gc.h"
#line 1 "..\\GUI\\lvgl_src\\lv_core\\../lv_misc/../lv_draw/lv_img_cache.h"
...
#line 17 "..\\GUI\\lvgl_src\\lv_core\\../lv_misc/../lv_draw/lv_img_cache.h"
...
#line 22 "..\\GUI\\lvgl_src\\lv_core\\../lv_misc/lv_gc.h"
#line 23 "..\\GUI\\lvgl_src\\lv_core\\../lv_misc/lv_gc.h"



 

#line 48 "..\\GUI\\lvgl_src\\lv_core\\../lv_misc/lv_gc.h"




#line 59 "..\\GUI\\lvgl_src\\lv_core\\../lv_misc/lv_gc.h"
...
#line 15 "..\\GUI\\lvgl_src\\lv_core\\lv_group.c"
...
void _lv_group_init(void)
{
    _lv_ll_init(&_lv_group_ll, sizeof(lv_group_t));
}
...
lv_group_t * lv_group_create(void)
{
    lv_group_t * group = _lv_ll_ins_head(&_lv_group_ll);
    do { if(!((lv_debug_check_null(group)))) { ; lv_debug_log_error("Out of memory", (uint64_t)((uintptr_t)group)); while(1); } } while(0);;
    if(group == 0) return 0;
...
void lv_group_del(lv_group_t * group)
{
    ...
    if(group->obj_focus != 0) {
        (*group->obj_focus)->signal_cb(*group->obj_focus, LV_SIGNAL_DEFOCUS, 0);
        lv_obj_invalidate(*group->obj_focus);
    }

     
    lv_obj_t ** obj;
    for(obj = _lv_ll_get_head(&group->obj_ll); obj != 0; obj = _lv_ll_get_next(&group->obj_ll, obj)) {
        (*obj)->group_p = 0;
    }

    _lv_ll_clear(&(group->obj_ll));
    _lv_ll_remove(&_lv_group_ll, group);
    lv_mem_free(group);
}
...
void lv_group_add_obj(lv_group_t * group, lv_obj_t * obj)
{
    ...
    lv_obj_t ** obj_i;
    for(obj_i = _lv_ll_get_head(&group->obj_ll); obj_i != 0; obj_i = _lv_ll_get_next(&group->obj_ll, obj_i)) {
        if((*obj_i) == obj) {
            ;
            return;
        }
    ...
    do { if(!((lv_debug_check_null(next)))) { ; lv_debug_log_error("Out of memory", (uint64_t)((uintptr_t)next)); while(1); } } while(0);;
    if(next == 0) return;
    *next = obj;
...
void lv_group_remove_obj(lv_obj_t * obj)
{
    ...
    if(*g->obj_focus == obj) {
        ...
        if(_lv_ll_get_head(&g->obj_ll) == g->obj_focus && _lv_ll_get_tail(&g->obj_ll) == g->obj_focus) {
            (*g->obj_focus)->signal_cb(*g->obj_focus, LV_SIGNAL_DEFOCUS, 0);
        }
    ...
    lv_obj_t ** i;
    for(i = _lv_ll_get_head(&g->obj_ll); i != 0; i = _lv_ll_get_next(&g->obj_ll, i)) {
        if(*i == obj) {
...
void lv_group_focus_obj(lv_obj_t * obj)
{
    ...
    if(g->obj_focus != 0 && obj == *g->obj_focus) return;
    ...
    for(i = _lv_ll_get_head(&g->obj_ll); i != 0; i = _lv_ll_get_next(&g->obj_ll, i)) {
        if(*i == obj) {
            if(g->obj_focus != 0) {
                (*g->obj_focus)->signal_cb(*g->obj_focus, LV_SIGNAL_DEFOCUS, 0);
                lv_res_t res = lv_event_send(*g->obj_focus, LV_EVENT_DEFOCUSED, 0);
            ...
            if(g->obj_focus != 0) {
                (*g->obj_focus)->signal_cb(*g->obj_focus, LV_SIGNAL_FOCUS, 0);
                if(g->focus_cb) g->focus_cb(g);
                lv_res_t res = lv_event_send(*g->obj_focus, LV_EVENT_FOCUSED, 0);
                if(res != LV_RES_OK) return;
                lv_obj_invalidate(*g->obj_focus);
...
void lv_group_set_editing(lv_group_t * group, _Bool edit)
{
    ...
    if(focused) {
        focused->signal_cb(focused, LV_SIGNAL_FOCUS, 0);  
        lv_res_t res = lv_event_send(*group->obj_focus, LV_EVENT_FOCUSED, 0);
        if(res != LV_RES_OK) return;
...
{
    if(!group) return 0;
    if(group->obj_focus == 0) return 0;

    return *group->obj_focus;
}

#line 389 "..\\GUI\\lvgl_src\\lv_core\\lv_group.c"
                            ...
                            void * (*move)(const lv_ll_t *, const void *))
{
    ...
    lv_obj_t ** obj_sentinel = 0;
    _Bool can_move            = 1;
    _Bool can_begin           = 1;

    for(;;) {
        if(obj_next == 0) {
            if(group->wrap || obj_sentinel == 0) {
                if(!can_begin) return;
    ...
    if(group->obj_focus) {
        (*group->obj_focus)->signal_cb(*group->obj_focus, LV_SIGNAL_DEFOCUS, 0);
        lv_res_t res = lv_event_send(*group->obj_focus, LV_EVENT_DEFOCUSED, 0);
        if(res != LV_RES_OK) return;
        lv_obj_invalidate(*group->obj_focus);
    }
    ...
    (*group->obj_focus)->signal_cb(*group->obj_focus, LV_SIGNAL_FOCUS, 0);
    lv_res_t res = lv_event_send(*group->obj_focus, LV_EVENT_FOCUSED, 0);
    if(res != LV_RES_OK) return;
