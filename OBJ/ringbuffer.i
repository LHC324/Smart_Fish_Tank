#line 1 "..\\IOT_PROTOCOL\\IOT_TOOLS\\ringbuffer.c"
...
#line 17 "..\\IOT_PROTOCOL\\IOT_TOOLS\\ringbuffer.c"
...
#line 18 "..\\IOT_PROTOCOL\\IOT_TOOLS\\ringbuffer.c"
...
int32_t  rbRead(rb_t *rb, void *data, size_t count)
{
    ...
    if (rb->rbHead < rb->rbTail)
    {
        copySz = (count)<(rbCanRead(rb))?(count):(rbCanRead(rb));
