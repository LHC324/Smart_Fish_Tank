...
#line 2 "..\\HARDWARE\\W25QXX\\w25qxx.c"
...
#line 3 "..\\HARDWARE\\W25QXX\\w25qxx.c"
...
#line 4 "..\\HARDWARE\\W25QXX\\w25qxx.c"
...
#line 5 "..\\HARDWARE\\W25QXX\\w25qxx.c"
#line 6 "..\\HARDWARE\\W25QXX\\w25qxx.c"
...
{ 
	...
	*((volatile unsigned long *)((((((0x40000000UL + 0x00020000UL) + 0x0400UL)+20) & 0xF0000000)+0x2000000+(((((0x40000000UL + 0x00020000UL) + 0x0400UL)+20) &0xFFFFF)<<5)+(0<<2))))=1;			                
	SPI_Init();		   			        
	SPI_SetSpeed((0x00000000U)); 
...
{  
	u8 byte=0;   
	*((volatile unsigned long *)((((((0x40000000UL + 0x00020000UL) + 0x0400UL)+20) & 0xF0000000)+0x2000000+(((((0x40000000UL + 0x00020000UL) + 0x0400UL)+20) &0xFFFFF)<<5)+(0<<2))))=0;                            
