#line 1 "..\\GUI\\lvgl_src\\lv_draw\\lv_draw_blend.c"
...
#line 1 "..\\GUI\\lvgl_src\\lv_draw\\lv_draw_blend.h"
...
#line 17 "..\\GUI\\lvgl_src\\lv_draw\\lv_draw_blend.h"
...
#line 18 "..\\GUI\\lvgl_src\\lv_draw\\lv_draw_blend.h"
#line 1 "..\\GUI\\lvgl_src\\lv_draw\\lv_draw_mask.h"
...
#line 17 "..\\GUI\\lvgl_src\\lv_draw\\lv_draw_mask.h"
#line 18 "..\\GUI\\lvgl_src\\lv_draw\\lv_draw_mask.h"
#line 19 "..\\GUI\\lvgl_src\\lv_draw\\lv_draw_mask.h"
...
#line 19 "..\\GUI\\lvgl_src\\lv_draw\\lv_draw_blend.h"
...
#line 10 "..\\GUI\\lvgl_src\\lv_draw\\lv_draw_blend.c"
...
#line 11 "..\\GUI\\lvgl_src\\lv_draw\\lv_draw_blend.c"
#line 12 "..\\GUI\\lvgl_src\\lv_draw\\lv_draw_blend.c"
...
#line 13 "..\\GUI\\lvgl_src\\lv_draw\\lv_draw_blend.c"
...
#line 14 "..\\GUI\\lvgl_src\\lv_draw\\lv_draw_blend.c"

#line 22 "..\\GUI\\lvgl_src\\lv_draw\\lv_draw_blend.c"
...
static void fill_set_px(const lv_area_t * disp_area, lv_color_t * disp_buf,  const lv_area_t * draw_area,
 ...
 static void fill_normal(const lv_area_t * disp_area, lv_color_t * disp_buf,
...
static void map_set_px(const lv_area_t * disp_area, lv_color_t * disp_buf,  const lv_area_t * draw_area,
 ...
 static void map_normal(const lv_area_t * disp_area, lv_color_t * disp_buf,
                                             const lv_area_t * draw_area,
                                             const lv_area_t * map_area, const lv_color_t * map_buf, lv_opa_t opa,
                                             const lv_opa_t * mask, lv_draw_mask_res_t mask_res);
...
#line 89 "..\\GUI\\lvgl_src\\lv_draw\\lv_draw_blend.c"


#line 99 "..\\GUI\\lvgl_src\\lv_draw\\lv_draw_blend.c"


#line 107 "..\\GUI\\lvgl_src\\lv_draw\\lv_draw_blend.c"

#line 116 "..\\GUI\\lvgl_src\\lv_draw\\lv_draw_blend.c"
 ...
 void _lv_blend_fill(const lv_area_t * clip_area, const lv_area_t * fill_area,
                                              ...
                                              const lv_opa_t * mask, lv_draw_mask_res_t mask_res)
{
    ...
    if(mask_res == LV_DRAW_MASK_RES_FULL_COVER) {
        if(opa > 253) {
#line 363 "..\\GUI\\lvgl_src\\lv_draw\\lv_draw_blend.c"
...
#line 395 "..\\GUI\\lvgl_src\\lv_draw\\lv_draw_blend.c"


#line 414 "..\\GUI\\lvgl_src\\lv_draw\\lv_draw_blend.c"
            lv_color_t last_dest_color = ((lv_color_t){{(uint16_t)((0x00 >> 3) & 0x1FU), (uint16_t)((0x00 >> 2) & 0x3FU), (uint16_t)((0x00 >> 3) & 0x1FU)}});
...
#line 433 "..\\GUI\\lvgl_src\\lv_draw\\lv_draw_blend.c"
                        {
...
#line 452 "..\\GUI\\lvgl_src\\lv_draw\\lv_draw_blend.c"
...
#line 476 "..\\GUI\\lvgl_src\\lv_draw\\lv_draw_blend.c"
                for(x = 0; x < draw_area_w && ((lv_uintptr_t)mask_tmp_x & 0x3); x++) {



                    if(*mask_tmp_x) { if(*mask_tmp_x == LV_OPA_COVER) disp_buf_first[x] = color; else disp_buf_first[x] = lv_color_mix(color, disp_buf_first[x], *mask_tmp_x); } mask_tmp_x++;
...
#line 501 "..\\GUI\\lvgl_src\\lv_draw\\lv_draw_blend.c"
                            if(*mask_tmp_x) { if(*mask_tmp_x == LV_OPA_COVER) disp_buf_first[x] = color; else disp_buf_first[x] = lv_color_mix(color, disp_buf_first[x], *mask_tmp_x); } mask_tmp_x++;
                            if(*mask_tmp_x) { if(*mask_tmp_x == LV_OPA_COVER) disp_buf_first[x + 1] = color; else disp_buf_first[x + 1] = lv_color_mix(color, disp_buf_first[x + 1], *mask_tmp_x); } mask_tmp_x++;
                            if(*mask_tmp_x) { if(*mask_tmp_x == LV_OPA_COVER) disp_buf_first[x + 2] = color; else disp_buf_first[x + 2] = lv_color_mix(color, disp_buf_first[x + 2], *mask_tmp_x); } mask_tmp_x++;
                            if(*mask_tmp_x) { if(*mask_tmp_x == LV_OPA_COVER) disp_buf_first[x + 3] = color; else disp_buf_first[x + 3] = lv_color_mix(color, disp_buf_first[x + 3], *mask_tmp_x); } mask_tmp_x++;
...
#line 541 "..\\GUI\\lvgl_src\\lv_draw\\lv_draw_blend.c"
                            {
        ...
        for(y = draw_area->y1; y <= draw_area->y2; y++) {
            for(x = draw_area->x1; x <= draw_area->x2; x++) {
                ...
                if(mask_tmp[x] != last_mask || last_dest_color.full != disp_buf_tmp[x].full) {
                    lv_opa_t opa_tmp = mask_tmp[x] >= 253 ? opa : (uint32_t)((uint32_t)mask_tmp[x] * opa) >> 8;
                                             ...
                                             const lv_opa_t * mask, lv_draw_mask_res_t mask_res)
{
    ...
    if(mask_res == LV_DRAW_MASK_RES_FULL_COVER) {
#line 757 "..\\GUI\\lvgl_src\\lv_draw\\lv_draw_blend.c"

        if(opa > 253) {
#line 807 "..\\GUI\\lvgl_src\\lv_draw\\lv_draw_blend.c"
...
#line 858 "..\\GUI\\lvgl_src\\lv_draw\\lv_draw_blend.c"

             

            for(y = 0; y < draw_area_h; y++) {
                for(x = 0; x < draw_area_w; x++) {
#line 870 "..\\GUI\\lvgl_src\\lv_draw\\lv_draw_blend.c"
                    {
        ...
        if(opa > 253) {
            ...
            for(y = 0; y < draw_area_h; y++) {
                ...
                for(x = 0; x < draw_area_w && ((lv_uintptr_t)mask_tmp_x & 0x3); x++) {
                    ...
                    if(*mask_tmp_x) { if(*mask_tmp_x == LV_OPA_COVER) disp_buf_first[x] = map_buf_first[x]; else disp_buf_first[x] = lv_color_mix(map_buf_first[x], disp_buf_first[x], *mask_tmp_x); } mask_tmp_x++;
                ...
                for(; x < x_end4; x += 4) {
                    if(*mask32) {
                        if((*mask32) == 0xFFFFFFFF) {
                            ...
                            mask_tmp_x = (const lv_opa_t *)mask32;
#line 919 "..\\GUI\\lvgl_src\\lv_draw\\lv_draw_blend.c"
                            if(*mask_tmp_x) { if(*mask_tmp_x == LV_OPA_COVER) disp_buf_first[x] = map_buf_first[x]; else disp_buf_first[x] = lv_color_mix(map_buf_first[x], disp_buf_first[x], *mask_tmp_x); } mask_tmp_x++;
                            if(*mask_tmp_x) { if(*mask_tmp_x == LV_OPA_COVER) disp_buf_first[x + 1] = map_buf_first[x + 1]; else disp_buf_first[x + 1] = lv_color_mix(map_buf_first[x + 1], disp_buf_first[x + 1], *mask_tmp_x); } mask_tmp_x++;
                            if(*mask_tmp_x) { if(*mask_tmp_x == LV_OPA_COVER) disp_buf_first[x + 2] = map_buf_first[x + 2]; else disp_buf_first[x + 2] = lv_color_mix(map_buf_first[x + 2], disp_buf_first[x + 2], *mask_tmp_x); } mask_tmp_x++;
                            if(*mask_tmp_x) { if(*mask_tmp_x == LV_OPA_COVER) disp_buf_first[x + 3] = map_buf_first[x + 3]; else disp_buf_first[x + 3] = lv_color_mix(map_buf_first[x + 3], disp_buf_first[x + 3], *mask_tmp_x); } mask_tmp_x++;
            ...
            for(y = 0; y < draw_area_h; y++) {
                for(x = 0; x < draw_area_w; x++) {
                    if(mask[x]) {
                        lv_opa_t opa_tmp = mask[x] >= 253 ? opa : ((opa * mask[x]) >> 8);
#line 956 "..\\GUI\\lvgl_src\\lv_draw\\lv_draw_blend.c"
                        {
                        ...
                        const lv_opa_t * mask, lv_draw_mask_res_t mask_res, lv_blend_mode_t mode)
{
    ...
    if(mask_res == LV_DRAW_MASK_RES_FULL_COVER) {
        ...
        for(y = draw_area->y1; y <= draw_area->y2; y++) {
            for(x = draw_area->x1; x <= draw_area->x2; x++) {
                if(mask_tmp[x] == 0) continue;
                lv_opa_t opa_tmp = mask_tmp[x] >= 253 ? opa : ((opa * mask_tmp[x]) >> 8);
...
static inline lv_color_t color_blend_true_color_additive(lv_color_t fg, lv_color_t bg, lv_opa_t opa)
{
    ...
    fg.ch.green = ((tmp) < (63) ? (tmp) : (63));
#line 1073 "..\\GUI\\lvgl_src\\lv_draw\\lv_draw_blend.c"
...
static inline lv_color_t color_blend_true_color_subtractive(lv_color_t fg, lv_color_t bg, lv_opa_t opa)
{
    ...
    int32_t tmp;
    tmp = bg.ch.red - fg.ch.red;
    fg.ch.red = ((tmp) > (0) ? (tmp) : (0));


    tmp = bg.ch.green - fg.ch.green;
    fg.ch.green = ((tmp) > (0) ? (tmp) : (0));
#line 1111 "..\\GUI\\lvgl_src\\lv_draw\\lv_draw_blend.c"

    tmp = bg.ch.blue - fg.ch.blue;
    fg.ch.blue = ((tmp) > (0) ? (tmp) : (0));
