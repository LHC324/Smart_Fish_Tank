...
#line 2 "..\\HARDWARE\\SDIO\\sdio_sdcard.c"
...
#line 3 "..\\HARDWARE\\SDIO\\sdio_sdcard.c"
...
#line 4 "..\\HARDWARE\\SDIO\\sdio_sdcard.c"
...
u8 SD_Init(void)
{
    ...
    SDCARD_Handler.Instance=((SDIO_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x2C00UL));
    SDCARD_Handler.Init.ClockEdge=0x00000000U;          			
    SDCARD_Handler.Init.ClockBypass=0x00000000U;     			
    SDCARD_Handler.Init.ClockPowerSave=0x00000000U;    	
    SDCARD_Handler.Init.BusWide=0x00000000U;                        	
    SDCARD_Handler.Init.HardwareFlowControl=0x00000000U;
    SDCARD_Handler.Init.ClockDiv=((uint8_t)0x1F);            			
    ...
    SD_Error=HAL_SD_ConfigWideBusOperation(&SDCARD_Handler,(0x1UL << (11U)));
...
void HAL_SD_MspInit(SD_HandleTypeDef *hsd)
{
    ...
    SDRxDMAHandler.Instance=((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6400UL) + 0x058UL));
    SDRxDMAHandler.Init.Channel=0x08000000U;
    SDRxDMAHandler.Init.Direction=0x00000000U;
    SDRxDMAHandler.Init.PeriphInc=0x00000000U;
    SDRxDMAHandler.Init.MemInc=((uint32_t)(0x1UL << (10U)));
    SDRxDMAHandler.Init.PeriphDataAlignment=((uint32_t)(0x2UL << (11U)));
    SDRxDMAHandler.Init.MemDataAlignment=((uint32_t)(0x2UL << (13U)));
    SDRxDMAHandler.Init.Mode=((uint32_t)(0x1UL << (5U)));
    SDRxDMAHandler.Init.Priority=((uint32_t)(0x3UL << (16U)));
    SDRxDMAHandler.Init.FIFOMode=((uint32_t)(0x1UL << (2U)));
    SDRxDMAHandler.Init.FIFOThreshold=((uint32_t)(0x3UL << (0U)));
    SDRxDMAHandler.Init.MemBurst=((uint32_t)(0x1UL << (23U)));
    SDRxDMAHandler.Init.PeriphBurst=((uint32_t)(0x1UL << (21U)));

    do{ (hsd)->hdmarx = &(SDRxDMAHandler); (SDRxDMAHandler). Parent = (hsd); } while(0U); 
    HAL_DMA_DeInit(&SDRxDMAHandler);
    HAL_DMA_Init(&SDRxDMAHandler);              
    
    
    SDTxDMAHandler.Instance=((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6400UL) + 0x0A0UL));
    SDTxDMAHandler.Init.Channel=0x08000000U;
    SDTxDMAHandler.Init.Direction=((uint32_t)(0x1UL << (6U)));
    SDTxDMAHandler.Init.PeriphInc=0x00000000U;
    SDTxDMAHandler.Init.MemInc=((uint32_t)(0x1UL << (10U)));
    SDTxDMAHandler.Init.PeriphDataAlignment=((uint32_t)(0x2UL << (11U)));
    SDTxDMAHandler.Init.MemDataAlignment=((uint32_t)(0x2UL << (13U)));
    SDTxDMAHandler.Init.Mode=((uint32_t)(0x1UL << (5U)));
    SDTxDMAHandler.Init.Priority=((uint32_t)(0x3UL << (16U)));
    SDTxDMAHandler.Init.FIFOMode=((uint32_t)(0x1UL << (2U)));
    SDTxDMAHandler.Init.FIFOThreshold=((uint32_t)(0x3UL << (0U)));
    SDTxDMAHandler.Init.MemBurst=((uint32_t)(0x1UL << (23U)));
    SDTxDMAHandler.Init.PeriphBurst=((uint32_t)(0x1UL << (21U)));
    
    do{ (hsd)->hdmatx = &(SDTxDMAHandler); (SDTxDMAHandler). Parent = (hsd); } while(0U);
...
u8 SD_GetCardState(void)
{
  return((HAL_SD_GetCardState(&SDCARD_Handler)==HAL_SD_CARD_TRANSFER )?((uint8_t)0x00):((uint8_t)0x01));
}
...
{
    u8 err=0;
	u32 timeout=((uint32_t)0x00002000);
	err=HAL_SD_ReadBlocks_DMA(&SDCARD_Handler,(uint8_t*)buf,sector,cnt);

	if(err==0)
	{
		
		while(SD_GetCardState()!=((uint8_t)0x00))
		{
			if(timeout-- == 0)
			{	
				err=((uint8_t)0x01);
...
u8 SD_WriteBlocks_DMA(uint32_t *buf,uint64_t sector,uint32_t blocksize,uint32_t cnt)
{
    u8 err=0; 
	u32 timeout=((uint32_t)0x00002000);
	err=HAL_SD_WriteBlocks_DMA(&SDCARD_Handler,(uint8_t*)buf,sector,cnt);
