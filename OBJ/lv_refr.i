#line 1 "..\\GUI\\lvgl_src\\lv_core\\lv_refr.c"
...
#line 10 "..\\GUI\\lvgl_src\\lv_core\\lv_refr.c"
...
#line 11 "..\\GUI\\lvgl_src\\lv_core\\lv_refr.c"
...
#line 12 "..\\GUI\\lvgl_src\\lv_core\\lv_refr.c"
#line 13 "..\\GUI\\lvgl_src\\lv_core\\lv_refr.c"
#line 14 "..\\GUI\\lvgl_src\\lv_core\\lv_refr.c"
#line 15 "..\\GUI\\lvgl_src\\lv_core\\lv_refr.c"
#line 16 "..\\GUI\\lvgl_src\\lv_core\\lv_refr.c"
#line 17 "..\\GUI\\lvgl_src\\lv_core\\lv_refr.c"
...
#line 18 "..\\GUI\\lvgl_src\\lv_core\\lv_refr.c"
#line 1 "..\\GUI\\lvgl_src\\lv_core\\../lv_draw/lv_draw.h"
...
#line 17 "..\\GUI\\lvgl_src\\lv_core\\../lv_draw/lv_draw.h"

#line 19 "..\\GUI\\lvgl_src\\lv_core\\../lv_draw/lv_draw.h"
#line 20 "..\\GUI\\lvgl_src\\lv_core\\../lv_draw/lv_draw.h"
#line 21 "..\\GUI\\lvgl_src\\lv_core\\../lv_draw/lv_draw.h"

#line 23 "..\\GUI\\lvgl_src\\lv_core\\../lv_draw/lv_draw.h"
#line 24 "..\\GUI\\lvgl_src\\lv_core\\../lv_draw/lv_draw.h"
#line 25 "..\\GUI\\lvgl_src\\lv_core\\../lv_draw/lv_draw.h"
#line 26 "..\\GUI\\lvgl_src\\lv_core\\../lv_draw/lv_draw.h"
#line 1 "..\\GUI\\lvgl_src\\lv_core\\../lv_draw/lv_draw_triangle.h"
...
#line 17 "..\\GUI\\lvgl_src\\lv_core\\../lv_draw/lv_draw_triangle.h"
...
#line 27 "..\\GUI\\lvgl_src\\lv_core\\../lv_draw/lv_draw.h"
#line 1 "..\\GUI\\lvgl_src\\lv_core\\../lv_draw/lv_draw_arc.h"
...
#line 17 "..\\GUI\\lvgl_src\\lv_core\\../lv_draw/lv_draw_arc.h"
...
#line 28 "..\\GUI\\lvgl_src\\lv_core\\../lv_draw/lv_draw.h"
#line 29 "..\\GUI\\lvgl_src\\lv_core\\../lv_draw/lv_draw.h"
#line 30 "..\\GUI\\lvgl_src\\lv_core\\../lv_draw/lv_draw.h"
...
#line 19 "..\\GUI\\lvgl_src\\lv_core\\lv_refr.c"
#line 1 "..\\GUI\\lvgl_src\\lv_core\\../lv_font/lv_font_fmt_txt.h"
...
#line 17 "..\\GUI\\lvgl_src\\lv_core\\../lv_font/lv_font_fmt_txt.h"
#line 18 "..\\GUI\\lvgl_src\\lv_core\\../lv_font/lv_font_fmt_txt.h"
#line 19 "..\\GUI\\lvgl_src\\lv_core\\../lv_font/lv_font_fmt_txt.h"
#line 20 "..\\GUI\\lvgl_src\\lv_core\\../lv_font/lv_font_fmt_txt.h"
...
typedef struct {
    ...
    int8_t ofs_x;                    
    int8_t ofs_y;                   
#line 46 "..\\GUI\\lvgl_src\\lv_core\\../lv_font/lv_font_fmt_txt.h"
...
#line 20 "..\\GUI\\lvgl_src\\lv_core\\lv_refr.c"
#line 1 "..\\GUI\\lvgl_src\\lv_core\\../lv_gpu/lv_gpu_stm32_dma2d.h"
...
#line 17 "..\\GUI\\lvgl_src\\lv_core\\../lv_gpu/lv_gpu_stm32_dma2d.h"
#line 18 "..\\GUI\\lvgl_src\\lv_core\\../lv_gpu/lv_gpu_stm32_dma2d.h"
...
#line 21 "..\\GUI\\lvgl_src\\lv_core\\lv_refr.c"
...
void _lv_inv_area(lv_disp_t * disp, const lv_area_t * area_p)
{
    ...
    if(suc != 0) {
        ...
        disp->inv_p++;
        lv_task_set_prio(disp->refr_task, LV_TASK_PRIO_MID);
    }
}
...
#line 242 "..\\GUI\\lvgl_src\\lv_core\\lv_refr.c"
...
#line 309 "..\\GUI\\lvgl_src\\lv_core\\lv_refr.c"
...
static void lv_refr_area_part(const lv_area_t * area_p)
{
    ...
    if(lv_disp_is_double_buf(disp_refr) == 0) {
        while(vdb->flushing) {
            if(disp_refr->driver.wait_cb) disp_refr->driver.wait_cb(&disp_refr->driver);
        }
    }

    lv_obj_t * top_act_scr = 0;
    lv_obj_t * top_prev_scr = 0;
    ...
    if(top_act_scr == 0 && top_prev_scr == 0) {
        if(disp_refr->bg_img) {
    ...
    if(lv_disp_is_true_double_buf(disp_refr) == 0) {
        lv_refr_vdb_flush();
    }
}
...
static lv_obj_t * lv_refr_get_top_obj(const lv_area_t * area_p, lv_obj_t * obj)
{
    ...
    if(_lv_area_is_in(area_p, &obj->coords, 0) && obj->hidden == 0) {
        ...
        if(design_res == LV_DESIGN_RES_MASKED) return 0;
...
static void lv_refr_obj_and_children(lv_obj_t * top_p, const lv_area_t * mask_p)
{
    ...
    if(top_p == 0) top_p = lv_disp_get_scr_act(disp_refr);
    if(top_p == 0) return;   
...
#line 696 "..\\GUI\\lvgl_src\\lv_core\\lv_refr.c"
        ...
        if(union_ok != 0) {
            ...
            for(child_p = _lv_ll_get_tail(&obj->child_ll); child_p != 0; child_p = _lv_ll_get_prev(&obj->child_ll, child_p)) {
