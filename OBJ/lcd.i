...
#line 2 "..\\HARDWARE\\LCD\\lcd.c"
#line 3 "..\\HARDWARE\\LCD\\lcd.c"
...
{   
	regval=regval;		
	((LCD_TypeDef *) ((u32)(0x60000000 | 0x00007FFFE)))->LCD_REG=regval;
}
...
{	  
	data=data;			
	((LCD_TypeDef *) ((u32)(0x60000000 | 0x00007FFFE)))->LCD_RAM=data;		 
}
...
{
	vu16 ram;			
	ram=((LCD_TypeDef *) ((u32)(0x60000000 | 0x00007FFFE)))->LCD_RAM;	
	return ram;	 
}
...
void LCD_WriteReg(u16 LCD_Reg,u16 LCD_RegValue)
{	
	((LCD_TypeDef *) ((u32)(0x60000000 | 0x00007FFFE)))->LCD_REG = LCD_Reg;		
	((LCD_TypeDef *) ((u32)(0x60000000 | 0x00007FFFE)))->LCD_RAM = LCD_RegValue;
}
...
void LCD_WriteRAM_Prepare(void)
{
 	((LCD_TypeDef *) ((u32)(0x60000000 | 0x00007FFFE)))->LCD_REG=lcddev.wramcmd;	  
}	 


void LCD_WriteRAM(u16 RGB_Code)
{							    
	((LCD_TypeDef *) ((u32)(0x60000000 | 0x00007FFFE)))->LCD_RAM = RGB_Code;
}
...
{ 
	...
	((LCD_TypeDef *) ((u32)(0x60000000 | 0x00007FFFE)))->LCD_RAM=POINT_COLOR;  
}
...
{	   
	...
	((LCD_TypeDef *) ((u32)(0x60000000 | 0x00007FFFE)))->LCD_REG=lcddev.wramcmd; 
	((LCD_TypeDef *) ((u32)(0x60000000 | 0x00007FFFE)))->LCD_RAM=color; 
}
...
{	
	...
	GPIO_Initure.Pin=((uint16_t)0x0001)|((uint16_t)0x0002)|((uint16_t)0x0010)|((uint16_t)0x0020)|((uint16_t)0x0080)|((uint16_t)0x0100) 
					|((uint16_t)0x0200)|((uint16_t)0x0400)|((uint16_t)0x2000)|((uint16_t)0x4000)|((uint16_t)0x8000);
	...
	GPIO_Initure.Pin=((uint16_t)0x0080)|((uint16_t)0x0100)|((uint16_t)0x0200)|((uint16_t)0x0400)|((uint16_t)0x0800)|
...
{ 	  
	...
	GPIO_Initure.Pin=((uint16_t)0x0002);          	
	...
	TFTSRAM_Handler.Init.NSBank=0x00000000U;     				
	...
	LCD_Display_Dir(1);		
	*((volatile unsigned long *)((((((0x40000000UL + 0x00020000UL) + 0x0400UL)+20) & 0xF0000000)+0x2000000+(((((0x40000000UL + 0x00020000UL) + 0x0400UL)+20) &0xFFFFF)<<5)+(1<<2))))=1;				
	LCD_Clear(0xFFFF);
}
...
{          
	...
	for(i=sy;i<=ey;i++)
	{
		LCD_SetCursor(sx,i);      				
		LCD_WriteRAM_Prepare();     			
		for(j=0;j<xlen;j++)((LCD_TypeDef *) ((u32)(0x60000000 | 0x00007FFFE)))->LCD_RAM=color;	
	}  
} 
...
{  
	...
	for(i=0;i<height;i++)
	{
		...
		LCD_WriteRAM_Prepare();     
		for(j=0;j<width;j++)((LCD_TypeDef *) ((u32)(0x60000000 | 0x00007FFFE)))->LCD_RAM=color[i*width+j];
	} 
} 
