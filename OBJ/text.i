...
void Show_Str_Mid(u16 x,u16 y,u8*str,u8 size,u8 len)
{
	...
	strlenth*=size/2;
	if(strlenth>len)Show_Str(x,y,128,160,str,size,1);
	else
	{
		strlenth=(len-strlenth)/2;
	    Show_Str(strlenth+x,y,128,160,str,size,1);
	}
}   
