#line 1 "..\\IOT_PROTOCOL\\gizwits_product.c"
...
#line 18 "..\\IOT_PROTOCOL\\gizwits_product.c"
...
#line 19 "..\\IOT_PROTOCOL\\gizwits_product.c"
#line 1 "..\\HARDWARE\\KEY\\hal_key.h"
...
#line 20 "..\\HARDWARE\\KEY\\hal_key.h"
...
#line 21 "..\\HARDWARE\\KEY\\hal_key.h"
...
#line 22 "..\\HARDWARE\\KEY\\hal_key.h"
...
#line 20 "..\\IOT_PROTOCOL\\gizwits_product.c"
...
#line 21 "..\\IOT_PROTOCOL\\gizwits_product.c"
#line 22 "..\\IOT_PROTOCOL\\gizwits_product.c"
...
#line 23 "..\\IOT_PROTOCOL\\gizwits_product.c"
...
#line 24 "..\\IOT_PROTOCOL\\gizwits_product.c"
...
#line 26 "..\\IOT_PROTOCOL\\gizwits_product.c"
...
#line 27 "..\\IOT_PROTOCOL\\gizwits_product.c"
...
#line 28 "..\\IOT_PROTOCOL\\gizwits_product.c"
...
#line 30 "..\\IOT_PROTOCOL\\gizwits_product.c"



static uint32_t timerMsCount;
uint8_t aRxBuffer;
uint8_t auto_flag = 0x00; 
uint8_t allow_flag = 0x00; 

_Bool wifi_success_flag = 0;
  ...
  for(i=0; i<info->num; i++){  
    switch(info->event[i]){
      case EVENT_Led_Auto:
        ...
        null_founction("Evt: EVENT_Led_Auto %d \r\n", currentDataPoint.valueLed_Auto);
      ...
      case WIFI_CON_M2M:
	    wifi_success_flag=1; 
		 null_founction("wifi connection succeeded\r\n");
        break;
      case WIFI_DISCON_M2M:
		wifi_success_flag=0; 
		 null_founction("wifi connection failed\r\n");
        break;
      case WIFI_RSSI:
        null_founction("RSSI %d\r\n", wifiData->rssi);
        break;
      case TRANSPARENT_DATA:
        null_founction("TRANSPARENT_DATA \r\n");
        
        break;
      case WIFI_NTP: 
		if((ptime->hour!=RTC_TimeStruct.Hours) ||(ptime->year!=RTC_DateStruct.Year)){
			RTC_Set_Time((ptime->hour),ptime->minute,ptime->second,((uint8_t)0x40)); 
			RTC_Set_Date((ptime->year)%100,ptime->month,ptime->day,4);	
			null_founction("RTC_clock is update!\r\n");
		}					
        null_founction("WIFI_NTP : [%d-%d-%d %02d:%02d:%02d][%d] \r\n",ptime->year,ptime->month,ptime->day,ptime->hour,ptime->minute,ptime->second,ptime->ntp);
        break;
      case MODULE_INFO:
            null_founction("MODULE INFO ...\r\n");




            null_founction("WIF MODULE ...\r\n");
            
            null_founction("moduleType : [%d] \r\n",ptModuleInfo->moduleType);
...
void userInit(void){
    memset((uint8_t*)&currentDataPoint, 0, sizeof(dataPoint_t));
      ...
      currentDataPoint.valueLed_Auto = 0x00; 
      ...
      currentDataPoint.valueTemperature_Min = 24;
	  ...
	  currentDataPoint.valueWater_level = 29; 
	  currentDataPoint.valueDefault_Water_Max = 25;
      currentDataPoint.valueDefault_Water_Min = 4;
	  ...
	  currentDataPoint.valueAdd_Oxygen_Duration = 1;
	  currentDataPoint.valueAdd_Oxygen_Interval = 1;
      ...
      currentDataPoint.valueFeed_Interval = 2;
...
uint32_t status_value;
	...
	status_value=ulPortRaiseBASEPRI();
    ...
    if(0 == buf){
		...
		for(i = 0; i < len; i++){ 
			...
			if(i >=2 && buf[i] == 0xFF){
			USART3_TX_BUF[buffer_size++] = 0x55; 
			}	
		}
		
		HAL_UART_Transmit_DMA(&UART3_Handler, (uint8_t *)&USART3_TX_BUF, buffer_size);
		while((((&UART3_Handler)->Instance ->SR & (((uint32_t)(0x1UL << (6U))))) == (((uint32_t)(0x1UL << (6U))))) == RESET){} 
		buffer_size = 0;
	...
	vPortSetBASEPRI(status_value);



    null_founction("MCU2WiFi[%4d:%4d]: ", gizGetTimerCount(), len);
    for(i=0; i<len; i++){    
        null_founction("%02x ", buf[i]);

        if(i >=2 && buf[i] == 0xFF){
            null_founction("%02x ", 0x55);
        }
    }
    null_founction("\r\n");
