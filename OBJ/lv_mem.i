#line 1 "..\\GUI\\lvgl_src\\lv_misc\\lv_mem.c"
...
#line 11 "..\\GUI\\lvgl_src\\lv_misc\\lv_mem.c"
...
#line 12 "..\\GUI\\lvgl_src\\lv_misc\\lv_mem.c"
...
#line 1 "..\\GUI\\lvgl_src\\lv_misc\\../lv_draw/../lv_core/../lv_misc/lv_debug.h"
...
#line 17 "..\\GUI\\lvgl_src\\lv_misc\\../lv_draw/../lv_core/../lv_misc/lv_debug.h"

#line 20 "..\\GUI\\lvgl_src\\lv_misc\\../lv_draw/../lv_core/../lv_misc/lv_debug.h"
...
#line 54 "..\\GUI\\lvgl_src\\lv_misc\\../lv_draw/../lv_core/../lv_misc/lv_debug.h"
...
#line 86 "..\\GUI\\lvgl_src\\lv_misc\\../lv_draw/../lv_core/../lv_misc/lv_debug.h"

#line 94 "..\\GUI\\lvgl_src\\lv_misc\\../lv_draw/../lv_core/../lv_misc/lv_debug.h"

#line 102 "..\\GUI\\lvgl_src\\lv_misc\\../lv_draw/../lv_core/../lv_misc/lv_debug.h"

#line 114 "..\\GUI\\lvgl_src\\lv_misc\\../lv_draw/../lv_core/../lv_misc/lv_debug.h"


#line 127 "..\\GUI\\lvgl_src\\lv_misc\\../lv_draw/../lv_core/../lv_misc/lv_debug.h"
...
#line 13 "..\\GUI\\lvgl_src\\lv_misc\\lv_mem.c"
#line 14 "..\\GUI\\lvgl_src\\lv_misc\\lv_mem.c"
...
#line 17 "..\\GUI\\lvgl_src\\lv_misc\\lv_mem.c"
...
static uint8_t mem_buf1_32[16];
static uint8_t mem_buf2_32[16];

static lv_mem_buf_t mem_buf_small[] = {{.p = mem_buf1_32, .size = 16, .used = 0},
    {.p = mem_buf2_32, .size = 16, .used = 0}
};
...
void _lv_mem_init(void)
{
#line 134 "..\\GUI\\lvgl_src\\lv_misc\\lv_mem.c"
}
...
void _lv_mem_deinit(void)
{
#line 149 "..\\GUI\\lvgl_src\\lv_misc\\lv_mem.c"
}
...
#line 188 "..\\GUI\\lvgl_src\\lv_misc\\lv_mem.c"
     



     
    alloc = pvPortMalloc(size + sizeof(lv_mem_header_t));
    if(alloc != 0) {
...
#line 219 "..\\GUI\\lvgl_src\\lv_misc\\lv_mem.c"
    }
...
#line 272 "..\\GUI\\lvgl_src\\lv_misc\\lv_mem.c"
    vPortFree(e);
...
#line 319 "..\\GUI\\lvgl_src\\lv_misc\\lv_mem.c"
    ...
    if(data_p != 0) {
        ...
        if(old_size != 0) {
            _lv_memcpy(new_p, data_p, ((new_size) < (old_size) ? (new_size) : (old_size)));
            lv_mem_free(data_p);
        }
    }
...
#line 349 "..\\GUI\\lvgl_src\\lv_misc\\lv_mem.c"
...
void lv_mem_defrag(void)
{
#line 392 "..\\GUI\\lvgl_src\\lv_misc\\lv_mem.c"
}

lv_res_t lv_mem_test(void)
{
#line 410 "..\\GUI\\lvgl_src\\lv_misc\\lv_mem.c"
    return LV_RES_OK;
}
...
#line 453 "..\\GUI\\lvgl_src\\lv_misc\\lv_mem.c"
}
...
#line 481 "..\\GUI\\lvgl_src\\lv_misc\\lv_mem.c"
...
void * _lv_mem_buf_get(uint32_t size)
{
    ...
    for(i = 0; i < 16; i++) {
        if(_lv_mem_buf[i].used == 0 && _lv_mem_buf[i].size >= size) {
            ...
            else if(_lv_mem_buf[i].size < _lv_mem_buf[i_guess].size) {
                i_guess = i;
            }
        }
    }
    ...
    if(i_guess >= 0) {
        _lv_mem_buf[i_guess].used = 1;
        return _lv_mem_buf[i_guess].p;
    }
    ...
    for(i = 0; i < 16; i++) {
        if(_lv_mem_buf[i].used == 0) {
            ...
            if(_lv_mem_buf[i].p == 0) {
                do { if(!(0)) { ; lv_debug_log_error("Out of memory, can't allocate a new  buffer (increase your LV_MEM_SIZE/heap size", (uint64_t)((uintptr_t)0x00)); while(1); } } while(0);
            }
            return  _lv_mem_buf[i].p;
        }
    }

    do { if(!(0)) { ; lv_debug_log_error("No free buffer. Increase LV_DRAW_BUF_MAX_NUM.", (uint64_t)((uintptr_t)0x00)); while(1); } } while(0);
    return 0;
}
 ...
 void * _lv_memcpy(void * dst, const void * src, size_t len)
{
    ...
    lv_uintptr_t d_align = (lv_uintptr_t)d8 & 0x3;
    lv_uintptr_t s_align = (lv_uintptr_t)s8 & 0x3;

     
    if(s_align != d_align) {
        while(len > 32) {
            *d8 = *s8; d8++; s8++; *d8 = *s8; d8++; s8++; *d8 = *s8; d8++; s8++; *d8 = *s8; d8++; s8++; *d8 = *s8; d8++; s8++; *d8 = *s8; d8++; s8++; *d8 = *s8; d8++; s8++; *d8 = *s8; d8++; s8++;;
            *d8 = *s8; d8++; s8++; *d8 = *s8; d8++; s8++; *d8 = *s8; d8++; s8++; *d8 = *s8; d8++; s8++; *d8 = *s8; d8++; s8++; *d8 = *s8; d8++; s8++; *d8 = *s8; d8++; s8++; *d8 = *s8; d8++; s8++;;
            *d8 = *s8; d8++; s8++; *d8 = *s8; d8++; s8++; *d8 = *s8; d8++; s8++; *d8 = *s8; d8++; s8++; *d8 = *s8; d8++; s8++; *d8 = *s8; d8++; s8++; *d8 = *s8; d8++; s8++; *d8 = *s8; d8++; s8++;;
            *d8 = *s8; d8++; s8++; *d8 = *s8; d8++; s8++; *d8 = *s8; d8++; s8++; *d8 = *s8; d8++; s8++; *d8 = *s8; d8++; s8++; *d8 = *s8; d8++; s8++; *d8 = *s8; d8++; s8++; *d8 = *s8; d8++; s8++;;
            len -= 32;
    ...
    while(len > 32) {
        *d32 = *s32; d32++; s32++; *d32 = *s32; d32++; s32++; *d32 = *s32; d32++; s32++; *d32 = *s32; d32++; s32++; *d32 = *s32; d32++; s32++; *d32 = *s32; d32++; s32++; *d32 = *s32; d32++; s32++; *d32 = *s32; d32++; s32++;
        len -= 32;
    }
 ...
 void _lv_memset(void * dst, uint8_t v, size_t len)
{
    ...
    uintptr_t d_align = (lv_uintptr_t) d8 & 0x3;
