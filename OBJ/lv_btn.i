#line 1 "..\\GUI\\lvgl_src\\lv_widgets\\lv_btn.c"
...
#line 11 "..\\GUI\\lvgl_src\\lv_widgets\\lv_btn.c"


#line 14 "..\\GUI\\lvgl_src\\lv_widgets\\lv_btn.c"
#line 15 "..\\GUI\\lvgl_src\\lv_widgets\\lv_btn.c"
#line 16 "..\\GUI\\lvgl_src\\lv_widgets\\lv_btn.c"
...
#line 17 "..\\GUI\\lvgl_src\\lv_widgets\\lv_btn.c"
...
#line 18 "..\\GUI\\lvgl_src\\lv_widgets\\lv_btn.c"
#line 19 "..\\GUI\\lvgl_src\\lv_widgets\\lv_btn.c"
#line 20 "..\\GUI\\lvgl_src\\lv_widgets\\lv_btn.c"
#line 21 "..\\GUI\\lvgl_src\\lv_widgets\\lv_btn.c"
...
lv_obj_t * lv_btn_create(lv_obj_t * par, const lv_obj_t * copy)
{
    ...
    do { if(!((lv_debug_check_null(btn)))) { ; lv_debug_log_error("Out of memory", (uint64_t)((uintptr_t)btn)); while(1); } } while(0);;
    if(btn == 0) return 0;

    if(ancestor_signal == 0) ancestor_signal = lv_obj_get_signal_cb(btn);
    if(ancestor_design == 0) ancestor_design = lv_obj_get_design_cb(btn);
    ...
    if(copy == 0) {
        ...
        if(par) {
            lv_obj_set_size(btn, 60, 60 / 3);
            lv_btn_set_layout(btn, LV_LAYOUT_CENTER);
        }

        lv_obj_set_click(btn, 1);  
        ...
        lv_obj_refresh_style(btn, LV_OBJ_PART_ALL, 0xFF);
    }
...
static lv_res_t lv_btn_signal(lv_obj_t * btn, lv_signal_t sign, void * param)
{
    ...
    if(sign == LV_SIGNAL_GET_TYPE) return lv_obj_handle_get_type_signal(param, "lv_btn");

    _Bool tgl           = lv_btn_get_checkable(btn);

    if(sign == LV_SIGNAL_RELEASED) {
        
 
        if(lv_indev_is_dragging(param) == 0 && tgl) {
            uint32_t toggled = 0;
            if(lv_obj_get_state(btn, LV_BTN_PART_MAIN) & LV_STATE_CHECKED) {
