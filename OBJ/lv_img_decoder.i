#line 1 "..\\GUI\\lvgl_src\\lv_draw\\lv_img_decoder.c"
...
#line 10 "..\\GUI\\lvgl_src\\lv_draw\\lv_img_decoder.c"
#line 11 "..\\GUI\\lvgl_src\\lv_draw\\lv_img_decoder.c"
#line 1 "..\\GUI\\lvgl_src\\lv_draw\\../lv_draw/lv_draw_img.h"
...
#line 17 "..\\GUI\\lvgl_src\\lv_draw\\../lv_draw/lv_draw_img.h"
#line 18 "..\\GUI\\lvgl_src\\lv_draw\\../lv_draw/lv_draw_img.h"
...
#line 12 "..\\GUI\\lvgl_src\\lv_draw\\lv_img_decoder.c"
#line 1 "..\\GUI\\lvgl_src\\lv_draw\\../lv_misc/lv_ll.h"
...
#line 17 "..\\GUI\\lvgl_src\\lv_draw\\../lv_misc/lv_ll.h"
#line 18 "..\\GUI\\lvgl_src\\lv_draw\\../lv_misc/lv_ll.h"
#line 19 "..\\GUI\\lvgl_src\\lv_draw\\../lv_misc/lv_ll.h"
#line 20 "..\\GUI\\lvgl_src\\lv_draw\\../lv_misc/lv_ll.h"
...
#line 13 "..\\GUI\\lvgl_src\\lv_draw\\lv_img_decoder.c"
#line 14 "..\\GUI\\lvgl_src\\lv_draw\\lv_img_decoder.c"
#line 1 "..\\GUI\\lvgl_src\\lv_draw\\../lv_misc/lv_gc.h"
...
#line 17 "..\\GUI\\lvgl_src\\lv_draw\\../lv_misc/lv_gc.h"
#line 18 "..\\GUI\\lvgl_src\\lv_draw\\../lv_misc/lv_gc.h"
#line 19 "..\\GUI\\lvgl_src\\lv_draw\\../lv_misc/lv_gc.h"
#line 20 "..\\GUI\\lvgl_src\\lv_draw\\../lv_misc/lv_gc.h"
#line 1 "..\\GUI\\lvgl_src\\lv_draw\\../lv_misc/lv_task.h"
...
#line 18 "..\\GUI\\lvgl_src\\lv_draw\\../lv_misc/lv_task.h"

#line 20 "..\\GUI\\lvgl_src\\lv_draw\\../lv_misc/lv_task.h"
#line 21 "..\\GUI\\lvgl_src\\lv_draw\\../lv_misc/lv_task.h"
#line 22 "..\\GUI\\lvgl_src\\lv_draw\\../lv_misc/lv_task.h"
#line 23 "..\\GUI\\lvgl_src\\lv_draw\\../lv_misc/lv_task.h"
...
#line 21 "..\\GUI\\lvgl_src\\lv_draw\\../lv_misc/lv_gc.h"
#line 1 "..\\GUI\\lvgl_src\\lv_draw\\../lv_misc/../lv_draw/lv_img_cache.h"
...
#line 17 "..\\GUI\\lvgl_src\\lv_draw\\../lv_misc/../lv_draw/lv_img_cache.h"
...
#line 22 "..\\GUI\\lvgl_src\\lv_draw\\../lv_misc/lv_gc.h"
#line 23 "..\\GUI\\lvgl_src\\lv_draw\\../lv_misc/lv_gc.h"



 

#line 48 "..\\GUI\\lvgl_src\\lv_draw\\../lv_misc/lv_gc.h"




#line 59 "..\\GUI\\lvgl_src\\lv_draw\\../lv_misc/lv_gc.h"
...
#line 15 "..\\GUI\\lvgl_src\\lv_draw\\lv_img_decoder.c"
...
void _lv_img_decoder_init(void)
{
    _lv_ll_init(&_lv_img_defoder_ll, sizeof(lv_img_decoder_t));
    ...
    if(decoder == 0) {
        ;
        do { if(!((lv_debug_check_null(decoder)))) { ; lv_debug_log_error("Out of memory", (uint64_t)((uintptr_t)decoder)); while(1); } } while(0);;
        return;
    }
...
lv_res_t lv_img_decoder_get_info(const char * src, lv_img_header_t * header)
{
    ...
    lv_img_decoder_t * d;
    for(d = _lv_ll_get_head(&_lv_img_defoder_ll); d != 0; d = _lv_ll_get_next(&_lv_img_defoder_ll, d)) {
        res = LV_RES_INV;
        if(d->info_cb) {
...
lv_res_t lv_img_decoder_open(lv_img_decoder_dsc_t * dsc, const void * src, lv_color_t color)
{
    ...
    for(d = _lv_ll_get_head(&_lv_img_defoder_ll); d != 0; d = _lv_ll_get_next(&_lv_img_defoder_ll, d)) {
        ...
        if(d->info_cb == 0 || d->open_cb == 0) continue;
...
{
    lv_img_decoder_t * decoder;
    decoder = _lv_ll_ins_head(&_lv_img_defoder_ll);
    do { if(!((lv_debug_check_null(decoder)))) { ; lv_debug_log_error("Out of memory", (uint64_t)((uintptr_t)decoder)); while(1); } } while(0);;
...
void lv_img_decoder_delete(lv_img_decoder_t * decoder)
{
    _lv_ll_remove(&_lv_img_defoder_ll, decoder);
    lv_mem_free(decoder);
}
...
lv_res_t lv_img_decoder_built_in_info(lv_img_decoder_t * decoder, const void * src, lv_img_header_t * header)
{
    ...
    if(src_type == LV_IMG_SRC_VARIABLE) {
        ...
        if(cf < LV_IMG_CF_TRUE_COLOR || cf > LV_IMG_CF_ALPHA_8BIT) return LV_RES_INV;

        header->w  = ((lv_img_dsc_t *)src)->header.w;
        header->h  = ((lv_img_dsc_t *)src)->header.h;
        header->cf = ((lv_img_dsc_t *)src)->header.cf;
    }
#line 297 "..\\GUI\\lvgl_src\\lv_draw\\lv_img_decoder.c"
...
lv_res_t lv_img_decoder_built_in_open(lv_img_decoder_t * decoder, lv_img_decoder_dsc_t * dsc)
{
    ...
    if(dsc->src_type == LV_IMG_SRC_FILE) {
#line 358 "..\\GUI\\lvgl_src\\lv_draw\\lv_img_decoder.c"
        ;
        return LV_RES_INV;
        ...
        if(((lv_img_dsc_t *)dsc->src)->data == 0) {
            return LV_RES_INV;
        }
    }
    ...
    if(cf == LV_IMG_CF_TRUE_COLOR || cf == LV_IMG_CF_TRUE_COLOR_ALPHA || cf == LV_IMG_CF_TRUE_COLOR_CHROMA_KEYED) {
        ...
        if(dsc->user_data == 0) {
            ...
            do { if(!((lv_debug_check_null(dsc->user_data)))) { ; lv_debug_log_error("Out of memory", (uint64_t)((uintptr_t)dsc->user_data)); while(1); } } while(0);;
            if(dsc->user_data == 0) {
                ;
        ...
        do { if(!((lv_debug_check_null(user_data->palette)))) { ; lv_debug_log_error("Out of memory", (uint64_t)((uintptr_t)user_data->palette)); while(1); } } while(0);;
        user_data->opa                             = lv_mem_alloc(palette_size * sizeof(lv_opa_t));
        do { if(!((lv_debug_check_null(user_data->opa)))) { ; lv_debug_log_error("Out of memory", (uint64_t)((uintptr_t)user_data->opa)); while(1); } } while(0);;
        if(user_data->palette == 0 || user_data->opa == 0) {
            ;
            lv_img_decoder_built_in_close(decoder, dsc);
            return LV_RES_INV;
        }
...
#line 427 "..\\GUI\\lvgl_src\\lv_draw\\lv_img_decoder.c"
            ;
            return LV_RES_INV;
...
void lv_img_decoder_built_in_close(lv_img_decoder_t * decoder, lv_img_decoder_dsc_t * dsc)
{
    ...
    lv_img_decoder_built_in_data_t * user_data = dsc->user_data;
    if(user_data) {
#line 531 "..\\GUI\\lvgl_src\\lv_draw\\lv_img_decoder.c"
...
static lv_res_t lv_img_decoder_built_in_line_true_color(lv_img_decoder_dsc_t * dsc, lv_coord_t x, lv_coord_t y,
                                                        lv_coord_t len, uint8_t * buf)
{
#line 570 "..\\GUI\\lvgl_src\\lv_draw\\lv_img_decoder.c"
    ((void) dsc);
    ((void) x);
    ((void) y);
    ((void) len);
                                                   ...
                                                   lv_coord_t len, uint8_t * buf)
{
    ...
    for(i = 0; i < len; i++) {
        ...
        buf[i * 3] = bg_color.full & 0xFF;
        buf[i * 3 + 1] = (bg_color.full >> 8) & 0xFF;
                                                     ...
                                                     lv_coord_t len, uint8_t * buf)
{
    ...
    for(i = 0; i < len; i++) {
        ...
        buf[i * 3] = color.full & 0xFF;
        buf[i * 3 + 1] = (color.full >> 8) & 0xFF;





        buf[i * 3 + 3 - 1] = user_data->opa[val_act];
