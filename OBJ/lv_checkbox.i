#line 1 "..\\GUI\\lvgl_src\\lv_widgets\\lv_checkbox.c"
...
#line 10 "..\\GUI\\lvgl_src\\lv_widgets\\lv_checkbox.c"


#line 13 "..\\GUI\\lvgl_src\\lv_widgets\\lv_checkbox.c"
#line 14 "..\\GUI\\lvgl_src\\lv_widgets\\lv_checkbox.c"
...
#line 15 "..\\GUI\\lvgl_src\\lv_widgets\\lv_checkbox.c"
...
lv_obj_t * lv_checkbox_create(lv_obj_t * par, const lv_obj_t * copy)
{
    ...
    do { if(!((lv_debug_check_null(cb)))) { ; lv_debug_log_error("Out of memory", (uint64_t)((uintptr_t)cb)); while(1); } } while(0);;
    if(cb == 0) return 0;

    if(ancestor_signal == 0) ancestor_signal = lv_obj_get_signal_cb(cb);
    ...
    if(copy == 0) {
        ext->bullet = lv_obj_create(cb, 0);
        lv_obj_set_click(ext->bullet, 0);

        ext->label = lv_label_create(cb, 0);

        lv_checkbox_set_text(cb, "Check box");
        lv_btn_set_layout(cb, LV_LAYOUT_ROW_MID);
        lv_btn_set_fit(cb, LV_FIT_TIGHT);
        lv_btn_set_checkable(cb, 1);
...
void lv_checkbox_set_text(lv_obj_t * cb, const char * txt)
{
    do { if(!((lv_debug_check_null(cb)))) { ; lv_debug_log_error("NULL pointer", (uint64_t)((uintptr_t)cb)); while(1); } } while(0);;
...
static lv_res_t lv_checkbox_signal(lv_obj_t * cb, lv_signal_t sign, void * param)
{
    ...
    if(sign == LV_SIGNAL_GET_TYPE) return lv_obj_handle_get_type_signal(param, "lv_checkbox");
