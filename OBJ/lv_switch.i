#line 1 "..\\GUI\\lvgl_src\\lv_widgets\\lv_switch.c"
...
#line 10 "..\\GUI\\lvgl_src\\lv_widgets\\lv_switch.c"
...
#line 19 "..\\GUI\\lvgl_src\\lv_widgets\\lv_switch.c"
...
#line 20 "..\\GUI\\lvgl_src\\lv_widgets\\lv_switch.c"
#line 21 "..\\GUI\\lvgl_src\\lv_widgets\\lv_switch.c"
#line 22 "..\\GUI\\lvgl_src\\lv_widgets\\lv_switch.c"
...
#line 23 "..\\GUI\\lvgl_src\\lv_widgets\\lv_switch.c"
...
#line 24 "..\\GUI\\lvgl_src\\lv_widgets\\lv_switch.c"
...
lv_obj_t * lv_switch_create(lv_obj_t * par, const lv_obj_t * copy)
{
    ...
    do { if(!((lv_debug_check_null(sw)))) { ; lv_debug_log_error("Out of memory", (uint64_t)((uintptr_t)sw)); while(1); } } while(0);;

    if(sw == 0) return 0;

    if(ancestor_signal == 0) ancestor_signal = lv_obj_get_signal_cb(sw);
    if(ancestor_design == 0) ancestor_design = lv_obj_get_design_cb(sw);
    ...
    if(copy == 0) {
        lv_obj_set_click(sw, 1);
        lv_obj_add_protect(sw, LV_PROTECT_PRESS_LOST);
        lv_obj_set_size(sw, (60 == 0 ? 0 :(((( lv_disp_get_dpi(0) * (60) + 80) / 160)) > (1) ? ((( lv_disp_get_dpi(0) * (60) + 80) / 160)) : (1))), (35 == 0 ? 0 :(((( lv_disp_get_dpi(0) * (35) + 80) / 160)) > (1) ? ((( lv_disp_get_dpi(0) * (35) + 80) / 160)) : (1))));
        ...
        lv_obj_refresh_style(sw, LV_OBJ_PART_ALL, 0xFF);
    }
...
void lv_switch_on(lv_obj_t * sw, lv_anim_enable_t anim)
{
    do { if(!((lv_debug_check_null(sw)))) { ; lv_debug_log_error("NULL pointer", (uint64_t)((uintptr_t)sw)); while(1); } } while(0);;
...
_Bool lv_switch_toggle(lv_obj_t * sw, lv_anim_enable_t anim)
{
    ...
    _Bool state = lv_switch_get_state(sw);
    if(state)
...
static lv_res_t lv_switch_signal(lv_obj_t * sw, lv_signal_t sign, void * param)
{
    ...
    if(sign == LV_SIGNAL_GET_TYPE) {
        ...
        return lv_obj_handle_get_type_signal(param, "lv_switch");
    }
    ...
    if(sign == LV_SIGNAL_CLEANUP) {
        ...
        res = lv_event_send(sw, LV_EVENT_VALUE_CHANGED, 0);
        if(res != LV_RES_OK) return res;
        ...
        lv_coord_t knob_size = ((lv_obj_get_width(sw)) < (lv_obj_get_height(sw)) ? (lv_obj_get_width(sw)) : (lv_obj_get_height(sw))) >> 1;
        ...
        sw->ext_draw_pad = ((sw->ext_draw_pad) > (knob_size) ? (sw->ext_draw_pad) : (knob_size));
    }
