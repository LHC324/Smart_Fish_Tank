...
TIM_HandleTypeDef TIM2_Handler,TIM3_Handler,TIM5_Handler,TIM7_Handler;      
TIM_OC_InitTypeDef TIM3_CH2Handler,TIM5_CHxHandler;	
...
void TIM7_Int_Init(u16 arr,u16 psc){
	TIM7_Handler.Instance=((TIM_TypeDef *) (0x40000000UL + 0x1400UL));                          
    TIM7_Handler.Init.Prescaler=psc;                     
    TIM7_Handler.Init.CounterMode=0x00000000U;    
    TIM7_Handler.Init.Period=arr;                        
    TIM7_Handler.Init.ClockDivision=0x00000000U;
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef *htim){
	...
	else if(htim->Instance==((TIM_TypeDef *) (0x40000000UL + 0x0000UL))){
...
void HAL_TIM_PWM_MspInit(TIM_HandleTypeDef *htim){
	if(htim==(&TIM3_Handler)){ 
		...
		GPIO_Initure.Alternate= ((uint8_t)0x02);	
		...
		GPIO_Initure.Pin=((uint16_t)0x0002)|((uint16_t)0x0004)|((uint16_t)0x0008);  
		GPIO_Initure.Mode=0x00000002U;  	
		GPIO_Initure.Pull=0x00000001U;          
		GPIO_Initure.Speed=0x00000002U;     
		GPIO_Initure.Alternate= ((uint8_t)0x02);	
...
void TIM2_Int_Init(u16 arr,u16 psc){
	TIM2_Handler.Instance=((TIM_TypeDef *) (0x40000000UL + 0x0000UL));                          
    TIM2_Handler.Init.Prescaler=psc;                     
    TIM2_Handler.Init.CounterMode=0x00000000U;    
    TIM2_Handler.Init.Period=arr;                        
    TIM2_Handler.Init.ClockDivision=0x00000000U;
    
	HAL_TIM_Base_Init(&TIM2_Handler);
    HAL_TIM_Base_Start_IT(&TIM2_Handler); 
	

	((TIM_TypeDef *) (0x40000000UL + 0x0000UL))->CR1&=~(1<<0);        
}
...
void TIM3_PWM_Init(u16 arr,u16 psc){
    ...
    TIM3_CH2Handler.OCMode=((0x4UL << (4U)) | (0x2UL << (4U))); 
    TIM3_CH2Handler.Pulse=0;          
    TIM3_CH2Handler.OCPolarity=0x00000000U; 
	
    HAL_TIM_PWM_ConfigChannel(&TIM3_Handler,&TIM3_CH2Handler,0x00000004U);
    HAL_TIM_PWM_Start(&TIM3_Handler,0x00000004U);
}
...
void TIM5_RGB_Init(u16 arr,u16 psc){	
	TIM5_Handler.Instance=((TIM_TypeDef *) (0x40000000UL + 0x0C00UL));          	
    TIM5_Handler.Init.Prescaler=psc;       
    TIM5_Handler.Init.CounterMode=0x00000000U;
    TIM5_Handler.Init.Period=arr;          
    TIM5_Handler.Init.ClockDivision=0x00000000U;
    HAL_TIM_PWM_Init(&TIM5_Handler);       

	TIM5_CHxHandler.OCMode=((0x4UL << (4U)) | (0x2UL << (4U))); 
    TIM5_CHxHandler.Pulse=0;          
    TIM5_CHxHandler.OCPolarity=(0x1UL << (1U)); 
	
    HAL_TIM_PWM_ConfigChannel(&TIM5_Handler,&TIM5_CHxHandler,0x00000004U);
	HAL_TIM_PWM_ConfigChannel(&TIM5_Handler,&TIM5_CHxHandler,0x00000008U);
	HAL_TIM_PWM_ConfigChannel(&TIM5_Handler,&TIM5_CHxHandler,0x0000000CU);
	
    HAL_TIM_PWM_Start(&TIM5_Handler,0x00000004U);
	HAL_TIM_PWM_Start(&TIM5_Handler,0x00000008U);
	HAL_TIM_PWM_Start(&TIM5_Handler,0x0000000CU);
}
