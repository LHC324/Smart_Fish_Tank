...
#line 2 "..\\HARDWARE\\PWM\\rgb.c"


void Set_Duty_Cycle(RGB_type RGBx,u8 dty){
    switch(RGBx){ 
        case R_LED:
            Set_TIMx_Comparex(((TIM_TypeDef *) (0x40000000UL + 0x0C00UL)),2,dty);
			break;
        case G_LED:
            Set_TIMx_Comparex(((TIM_TypeDef *) (0x40000000UL + 0x0C00UL)),3,dty);
			break;		
        case B_LED:
            Set_TIMx_Comparex(((TIM_TypeDef *) (0x40000000UL + 0x0C00UL)),4,dty);
			break;
        default:
            Set_TIMx_Comparex(((TIM_TypeDef *) (0x40000000UL + 0x0C00UL)),5,0);
			break;			
    }    
}
