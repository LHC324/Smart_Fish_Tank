#line 1 "..\\GUI\\lvgl_src\\lv_widgets\\lv_label.c"
...
#line 10 "..\\GUI\\lvgl_src\\lv_widgets\\lv_label.c"
#line 12 "..\\GUI\\lvgl_src\\lv_widgets\\lv_label.c"
#line 13 "..\\GUI\\lvgl_src\\lv_widgets\\lv_label.c"
...
#line 14 "..\\GUI\\lvgl_src\\lv_widgets\\lv_label.c"
#line 15 "..\\GUI\\lvgl_src\\lv_widgets\\lv_label.c"
#line 16 "..\\GUI\\lvgl_src\\lv_widgets\\lv_label.c"
#line 17 "..\\GUI\\lvgl_src\\lv_widgets\\lv_label.c"
#line 18 "..\\GUI\\lvgl_src\\lv_widgets\\lv_label.c"
#line 1 "..\\GUI\\lvgl_src\\lv_widgets\\../lv_misc/lv_txt_ap.h"
...
#line 17 "..\\GUI\\lvgl_src\\lv_widgets\\../lv_misc/lv_txt_ap.h"
#line 18 "..\\GUI\\lvgl_src\\lv_widgets\\../lv_misc/lv_txt_ap.h"
#line 19 "..\\GUI\\lvgl_src\\lv_widgets\\../lv_misc/lv_txt_ap.h"

#line 55 "..\\GUI\\lvgl_src\\lv_widgets\\../lv_misc/lv_txt_ap.h"





#line 19 "..\\GUI\\lvgl_src\\lv_widgets\\lv_label.c"
#line 1 "..\\GUI\\lvgl_src\\lv_widgets\\../lv_misc/lv_printf.h"
...
#line 41 "..\\GUI\\lvgl_src\\lv_widgets\\../lv_misc/lv_printf.h"



#line 45 "..\\GUI\\lvgl_src\\lv_widgets\\../lv_misc/lv_printf.h"
#line 46 "..\\GUI\\lvgl_src\\lv_widgets\\../lv_misc/lv_printf.h"
...
#line 20 "..\\GUI\\lvgl_src\\lv_widgets\\lv_label.c"
...
#line 21 "..\\GUI\\lvgl_src\\lv_widgets\\lv_label.c"
...
static _Bool lv_label_set_dot_tmp(lv_obj_t * label, char * data, uint32_t len);
...
lv_obj_t * lv_label_create(lv_obj_t * par, const lv_obj_t * copy)
{
    ...
    do { if(!((lv_debug_check_null(new_label)))) { ; lv_debug_log_error("Out of memory", (uint64_t)((uintptr_t)new_label)); while(1); } } while(0);;
    if(new_label == 0) return 0;

    if(ancestor_signal == 0) ancestor_signal = lv_obj_get_signal_cb(new_label);
    ...
    if(copy == 0) {
        ...
        if(copy_ext->long_mode == LV_LABEL_LONG_DOT) {
            ...
            do { if(!((lv_debug_check_null(ext->text)))) { ; lv_debug_log_error("Out of memory", (uint64_t)((uintptr_t)ext->text)); while(1); } } while(0);;
            if(ext->text == 0) return 0;
        ...
        lv_obj_refresh_style(new_label, LV_OBJ_PART_ALL, 0xFF);
    }
...
void lv_label_set_text(lv_obj_t * label, const char * text)
{
    do { if(!((lv_debug_check_null(label)))) { ; lv_debug_log_error("NULL pointer", (uint64_t)((uintptr_t)label)); while(1); } } while(0);;
    ...
    do { if(!((lv_debug_check_null(text)))) { ; lv_debug_log_error("NULL pointer", (uint64_t)((uintptr_t)text)); while(1); } } while(0);;

    if(ext->text == text && ext->static_txt == 0) {
         
#line 209 "..\\GUI\\lvgl_src\\lv_widgets\\lv_label.c"
        ext->text = lv_mem_realloc(ext->text, strlen(ext->text) + 1);


        do { if(!((lv_debug_check_null(ext->text)))) { ; lv_debug_log_error("Out of memory", (uint64_t)((uintptr_t)ext->text)); while(1); } } while(0);;
        if(ext->text == 0) return;
    }
    else {
         
        if(ext->text != 0 && ext->static_txt == 0) {
            lv_mem_free(ext->text);
            ext->text = 0;
        }

#line 232 "..\\GUI\\lvgl_src\\lv_widgets\\lv_label.c"
...
{
    do { if(!((lv_debug_check_null(label)))) { ; lv_debug_log_error("NULL pointer", (uint64_t)((uintptr_t)label)); while(1); } } while(0);;
    do { if(!((lv_debug_check_null(fmt)))) { ; lv_debug_log_error("NULL pointer", (uint64_t)((uintptr_t)fmt)); while(1); } } while(0);;
    ...
    uint32_t len = lv_vsnprintf(0, 0, fmt, ap);
    __va_end(ap);

#line 306 "..\\GUI\\lvgl_src\\lv_widgets\\lv_label.c"
...
void lv_label_set_text_static(lv_obj_t * label, const char * text)
{
    ...
    lv_label_ext_t * ext = lv_obj_get_ext_attr(label);
    if(ext->static_txt == 0 && ext->text != 0) {
        lv_mem_free(ext->text);
        ext->text = 0;
    }
...
void lv_label_set_long_mode(lv_obj_t * label, lv_label_long_mode_t long_mode)
{
    ...
    if(ext->long_mode == LV_LABEL_LONG_DOT && ext->dot_end != 0xFFFF) {
...
#line 524 "..\\GUI\\lvgl_src\\lv_widgets\\lv_label.c"
...
{
    do { if(!((lv_debug_check_null(label)))) { ; lv_debug_log_error("NULL pointer", (uint64_t)((uintptr_t)label)); while(1); } } while(0);;
    do { if(!((lv_debug_check_null(pos)))) { ; lv_debug_log_error("NULL pointer", (uint64_t)((uintptr_t)pos)); while(1); } } while(0);;
...
#line 655 "..\\GUI\\lvgl_src\\lv_widgets\\lv_label.c"
...
{
    do { if(!((lv_debug_check_null(label)))) { ; lv_debug_log_error("NULL pointer", (uint64_t)((uintptr_t)label)); while(1); } } while(0);;
    do { if(!((lv_debug_check_null(pos_in)))) { ; lv_debug_log_error("NULL pointer", (uint64_t)((uintptr_t)pos_in)); while(1); } } while(0);;
...
#line 748 "..\\GUI\\lvgl_src\\lv_widgets\\lv_label.c"
    ...
    if(new_line_start > 0) {
        while(i + line_start < new_line_start) {
            ...
            uint32_t letter_next = _lv_txt_encoded_next(&bidi_txt[i], 0);
...
#line 811 "..\\GUI\\lvgl_src\\lv_widgets\\lv_label.c"
...
_Bool lv_label_is_char_under_pos(const lv_obj_t * label, lv_point_t * pos)
{
    ...
    if(new_line_start > 0) {
        while(i <= new_line_start - 1) {
            ...
            letter_next = _lv_txt_encoded_next(&txt[i], 0);
...
#line 1004 "..\\GUI\\lvgl_src\\lv_widgets\\lv_label.c"
...
static lv_design_res_t lv_label_design(lv_obj_t * label, const lv_area_t * clip_area, lv_design_mode_t mode)
{
    ...
    if(mode == LV_DESIGN_COVER_CHK)
        ...
        lv_area_t txt_clip;
        _Bool is_common = _lv_area_intersect(&txt_clip, clip_area, &txt_coords);
        ...
        if((ext->long_mode == LV_LABEL_LONG_SROLL || ext->long_mode == LV_LABEL_LONG_SROLL_CIRC) &&
           (ext->align == LV_LABEL_ALIGN_CENTER || ext->align == LV_LABEL_ALIGN_RIGHT)) {
            ...
            _lv_txt_get_size(&size, ext->text, label_draw_dsc.font, label_draw_dsc.letter_space, label_draw_dsc.line_space,
                             ((lv_coord_t)((uint32_t)((uint32_t)1 << (8 * sizeof(lv_coord_t) - 1)) - 1000)), flag);
            if(size.x > lv_area_get_width(&txt_coords)) {
                label_draw_dsc.flag &= ~LV_TXT_FLAG_RIGHT;
                label_draw_dsc.flag &= ~LV_TXT_FLAG_CENTER;
            }
        }
#line 1116 "..\\GUI\\lvgl_src\\lv_widgets\\lv_label.c"
         
        lv_draw_label_hint_t * hint = 0;
        ...
        if(ext->long_mode == LV_LABEL_LONG_SROLL_CIRC) {
            ...
            if(size.x > lv_area_get_width(&txt_coords)) {
                label_draw_dsc.ofs_x = ext->offset.x + size.x +
                                       lv_font_get_glyph_width(label_draw_dsc.font, ' ', ' ') * 3;
                label_draw_dsc.ofs_y = ext->offset.y;
...
static lv_res_t lv_label_signal(lv_obj_t * label, lv_signal_t sign, void * param)
{
    ...
    if(sign == LV_SIGNAL_GET_TYPE) return lv_obj_handle_get_type_signal(param, "lv_label");
...
static void lv_label_refr_text(lv_obj_t * label)
{
    ...
    if(ext->long_mode == LV_LABEL_LONG_EXPAND) {
        ...
        _Bool hor_anim = 0;
        if(size.x > lv_area_get_width(&txt_coords)) {
            lv_anim_set_values(&a, 0, -size.x - lv_font_get_glyph_width(font, ' ', ' ') * 3);
            lv_anim_set_exec_cb(&a, (lv_anim_exec_xcb_t)lv_label_set_offset_x);
            lv_anim_set_time(&a, lv_anim_speed_to_time(ext->anim_speed, a.start, a.end));
        ...
        if(size.y <= lv_area_get_height(&txt_coords)) {  
        ...
        else if(_lv_txt_get_encoded_length(ext->text) <= 3) {    
            ext->dot_end = 0xFFFF;
        }
        else {
            lv_point_t p;
            ...
            p.y -= p.y %
                   (lv_font_get_line_height(font) + line_space);  
            p.y -= line_space;                                                
            ...
            if(lv_label_set_dot_tmp(label, &ext->text[byte_id_ori], len)) {
                ...
                ext->text[byte_id_ori + 3] = '\0';
                ext->dot_end                              = letter_id + 3;
            }
        }
    }
...
static void lv_label_revert_dots(lv_obj_t * label)
{
    ...
    if(ext->dot_end == 0xFFFF) return;
    uint32_t letter_i = ext->dot_end - 3;
