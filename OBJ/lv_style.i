#line 1 "..\\GUI\\lvgl_src\\lv_core\\lv_style.c"
...
#line 10 "..\\GUI\\lvgl_src\\lv_core\\lv_style.c"
#line 11 "..\\GUI\\lvgl_src\\lv_core\\lv_style.c"
#line 12 "..\\GUI\\lvgl_src\\lv_core\\lv_style.c"
...
#line 26 "..\\GUI\\lvgl_src\\lv_core\\lv_style.c"
...
void lv_style_copy(lv_style_t * style_dest, const lv_style_t * style_src)
{
    if(style_src == 0) return;

    ;
    ;

    if(style_src->map == 0) return;
...
_Bool lv_style_remove_prop(lv_style_t * style, lv_style_property_t prop)
{
    ...
    if(id >= 0) {
        ...
        if(((attr_found)&0x7F) == ((attr_goal)&0x7F)) {
...
void lv_style_list_copy(lv_style_list_t * list_dest, const lv_style_list_t * list_src)
{
    ...
    if(list_src->style_list == 0) return;
...
void _lv_style_list_add_style(lv_style_list_t * list, lv_style_t * style)
{
    ...
    do { if(!((lv_debug_check_null(new_classes)))) { ; lv_debug_log_error("Out of memory", (uint64_t)((uintptr_t)new_classes)); while(1); } } while(0);;
    if(new_classes == 0) {
        ;
        return;
    }
...
uint16_t _lv_style_get_mem_size(const lv_style_t * style)
{
    ...
    if(style->map == 0) return 0;

    size_t i = 0;
    uint8_t prop_id;
    while((prop_id = get_style_prop_id(style, i)) != 0xFF) {
...
void _lv_style_set_int(lv_style_t * style, lv_style_property_t prop, lv_style_int_t value)
{
    ...
    lv_style_property_t end_mark = 0xFF;
    ...
    do { if(!((lv_debug_check_null(style ->map)))) { ; lv_debug_log_error("Out of memory", (uint64_t)((uintptr_t)style ->map)); while(1); } } while(0);;
    if(style == 0) return;
...
int16_t _lv_style_get_int(const lv_style_t * style, lv_style_property_t prop, void * v_res)
{
    ...
    if(id < 0) {
        ...
        return ((attr_act)&0x7F) & ((attr_goal)&0x7F);
    }
}
...
lv_style_t * _lv_style_list_add_trans_style(lv_style_list_t * list)
{
    ...
    do { if(!((lv_debug_check_null(trans_style)))) { ; lv_debug_log_error("Out of memory", (uint64_t)((uintptr_t)trans_style)); while(1); } } while(0);;
    if(trans_style == 0) {
        ;
        return 0;
    }
...
lv_res_t _lv_style_list_get_int(lv_style_list_t * list, lv_style_property_t prop, lv_style_int_t * res)
{
    ...
    if(list == 0) return LV_RES_INV;
    if(list->style_list == 0) return LV_RES_INV;
...
#line 1021 "..\\GUI\\lvgl_src\\lv_core\\lv_style.c"
...
#line 1040 "..\\GUI\\lvgl_src\\lv_core\\lv_style.c"
 ...
 static inline int32_t get_property_index(const lv_style_t * style, lv_style_property_t prop)
{
    ...
    while((prop_id = get_style_prop_id(style, i)) != 0xFF) {
        if(prop_id == id_to_find) {
            ...
            if(((attr_i)&0x7F) == ((attr)&0x7F)) {
                return i;
            }
            
 
            else if((((attr_i)&0x7F) & (~((attr)&0x7F))) == 0) {
                
 
                if(((attr_i)&0x7F) > weight) {
                    weight = ((attr_i)&0x7F);
                    id_guess = i;
                }
            }
...
static lv_style_t * get_alloc_local_style(lv_style_list_t * list)
{
    ...
    do { if(!((lv_debug_check_null(local_style)))) { ; lv_debug_log_error("Out of memory", (uint64_t)((uintptr_t)local_style)); while(1); } } while(0);;
    if(local_style == 0) {
        ;
        return 0;
    }
...
static inline size_t get_prop_size(uint8_t prop_id)
{
    ...
    if(prop_id < 0x9) size += sizeof(lv_style_int_t);
    else if(prop_id < 0xC) size += sizeof(lv_color_t);
    else if(prop_id < 0xE) size += sizeof(lv_opa_t);
