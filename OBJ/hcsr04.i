#line 1 "..\\HARDWARE\\HCSR04\\hcsr04.c"
...
#line 2 "..\\HARDWARE\\HCSR04\\hcsr04.c"
...
#line 3 "..\\HARDWARE\\HCSR04\\hcsr04.c"
...
#line 4 "..\\HARDWARE\\HCSR04\\hcsr04.c"
...
#line 5 "..\\HARDWARE\\HCSR04\\hcsr04.c"
...
#line 6 "..\\HARDWARE\\HCSR04\\hcsr04.c"
...
#line 7 "..\\HARDWARE\\HCSR04\\hcsr04.c"
...
void Hcsr04_Init(void){
	...
	GPIO_Initure.Pin=((uint16_t)0x0010); 
	...
	TIM2_Int_Init(25000-1,84-1);
}




static void Open_Timer_ForHc(){        
...
u32 Get_Echo_Timer(void){
	...
	t =((TIM_TypeDef *) (0x40000000UL + 0x0000UL))->CNT;
    ((TIM_TypeDef *) (0x40000000UL + 0x0000UL))->CNT = 0;  
...
float Hcsr04_Get_Length(void )
{
    ...
    while(i++ != 5){ 
	   overtime =0; 
       *((volatile unsigned long *)((((((0x40000000UL + 0x00020000UL) + 0x0000UL)+20) & 0xF0000000)+0x2000000+(((((0x40000000UL + 0x00020000UL) + 0x0000UL)+20) &0xFFFFF)<<5)+(4<<2)))) = 1;      
       delay_us(20);
       *((volatile unsigned long *)((((((0x40000000UL + 0x00020000UL) + 0x0000UL)+20) & 0xF0000000)+0x2000000+(((((0x40000000UL + 0x00020000UL) + 0x0000UL)+20) &0xFFFFF)<<5)+(4<<2)))) = 0;
       while((*((volatile unsigned long *)((((((0x40000000UL + 0x00020000UL) + 0x0000UL)+16) & 0xF0000000)+0x2000000+(((((0x40000000UL + 0x00020000UL) + 0x0000UL)+16) &0xFFFFF)<<5)+(5<<2)))) == 0) && (overtime++ <= 2000000U));     
            overtime =0; 
			Open_Timer_ForHc();        
            while((*((volatile unsigned long *)((((((0x40000000UL + 0x00020000UL) + 0x0000UL)+16) & 0xF0000000)+0x2000000+(((((0x40000000UL + 0x00020000UL) + 0x0000UL)+16) &0xFFFFF)<<5)+(5<<2))))) == 1 && (overtime++ <= 2000000U));
            Close_Timer_ForHc();        
            length_Temp = Get_Echo_Timer()/58.3;        
        sum += length_Temp;
    }
    length_Temp = sum/5.0;
