#line 1 "..\\IOT_PROTOCOL\\gizwits_protocol.c"
...
#line 1 "..\\IOT_PROTOCOL\\IOT_TOOLS\\ringBuffer.h"
...
#line 24 "..\\IOT_PROTOCOL\\IOT_TOOLS\\ringBuffer.h"
...
#line 25 "..\\IOT_PROTOCOL\\IOT_TOOLS\\ringBuffer.h"
...
#line 26 "..\\IOT_PROTOCOL\\IOT_TOOLS\\ringBuffer.h"
...
#line 27 "..\\IOT_PROTOCOL\\IOT_TOOLS\\ringBuffer.h"
...
#line 17 "..\\IOT_PROTOCOL\\gizwits_protocol.c"
...
#line 18 "..\\IOT_PROTOCOL\\gizwits_protocol.c"
#line 1 "..\\IOT_PROTOCOL\\IOT_TOOLS\\dataPointTools.h"
...
#line 24 "..\\IOT_PROTOCOL\\IOT_TOOLS\\dataPointTools.h"
#line 25 "..\\IOT_PROTOCOL\\IOT_TOOLS\\dataPointTools.h"
#line 26 "..\\IOT_PROTOCOL\\IOT_TOOLS\\dataPointTools.h"
#line 27 "..\\IOT_PROTOCOL\\IOT_TOOLS\\dataPointTools.h"
...
#line 19 "..\\IOT_PROTOCOL\\gizwits_protocol.c"
...
rb_t pRb;                                               
static uint8_t rbBuf[((sizeof(devStatus_t)+sizeof(attrFlags_t)+20)*2)];                       
...
int32_t gizPutData(uint8_t *buf, uint32_t len)
{
    ...
    if(0 == buf)
    {
        null_founction("ERR: gizPutData buf is empty \r\n");
        return -1;
    }
    ...
    if(count != len)
    {
        null_founction("ERR: Failed to rbWrite \r\n");
        return -1;
    }
...
static int8_t gizProtocolHeadInit(protocolHead_t *head)
{
    if(0 == head)
    {
        null_founction("ERR: gizProtocolHeadInit head is empty \r\n");
        return -1;
    }
...
static int8_t gizProtocolWaitAck(uint8_t *gizdata, uint32_t len)
{
    if(0 == gizdata)
    {
        null_founction("ERR: data is empty \r\n");
        return -1;
    }
...
{
    if((0 == issuedData) || (0 == info) ||(0 == dataPoints))
    {
        null_founction("gizDataPoint2Event Error , Illegal Param\r\n");
        return -1;
    }
    ...
    if(sizeof(issuedData->attrFlags) > 1)
    {
        ...
        {
            null_founction("gizByteOrderExchange Error\r\n");
            return -1;
        }
    }
    ...
    if(0x01 == issuedData->attrFlags.flagLed_Auto)
    {
        ...
        info->num++;
        dataPoints->valueLed_Auto = gizStandardDecompressionValue(0,0,1,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
    ...
    if(0x01 == issuedData->attrFlags.flagTemperature_Auto)
    {
        ...
        info->num++;
        dataPoints->valueTemperature_Auto = gizStandardDecompressionValue(0,1,1,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
    ...
    if(0x01 == issuedData->attrFlags.flagAdd_Temperature)
    {
        ...
        info->num++;
        dataPoints->valueAdd_Temperature = gizStandardDecompressionValue(0,2,1,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
    ...
    if(0x01 == issuedData->attrFlags.flagOxygen_Auto)
    {
        ...
        info->num++;
        dataPoints->valueOxygen_Auto = gizStandardDecompressionValue(0,3,1,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
    ...
    if(0x01 == issuedData->attrFlags.flagOxygen_Pump)
    {
        ...
        info->num++;
        dataPoints->valueOxygen_Pump = gizStandardDecompressionValue(0,4,1,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
    ...
    if(0x01 == issuedData->attrFlags.flagWater_Level_Auto)
    {
        ...
        info->num++;
        dataPoints->valueWater_Level_Auto = gizStandardDecompressionValue(0,5,1,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
    ...
    if(0x01 == issuedData->attrFlags.flagPump)
    {
        ...
        info->num++;
        dataPoints->valuePump = gizStandardDecompressionValue(0,6,1,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
    ...
    if(0x01 == issuedData->attrFlags.flagFeed_Auto)
    {
        ...
        info->num++;
        dataPoints->valueFeed_Auto = gizStandardDecompressionValue(0,7,1,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
    ...
    if(0x01 == issuedData->attrFlags.flagServo)
    {
        ...
        info->num++;
        dataPoints->valueServo = gizStandardDecompressionValue(1,8,3,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
    ...
    if(0x01 == issuedData->attrFlags.flagRGB_R)
    {
        ...
        info->num++;
        dataPoints->valueRGB_R = gizX2Y(1,  0, issuedData->attrVals.valueRGB_R); 
    }
    ...
    if(0x01 == issuedData->attrFlags.flagRGB_G)
    {
        ...
        info->num++;
        dataPoints->valueRGB_G = gizX2Y(1,  0, issuedData->attrVals.valueRGB_G); 
    }
    ...
    if(0x01 == issuedData->attrFlags.flagRGB_B)
    {
        ...
        info->num++;
        dataPoints->valueRGB_B = gizX2Y(1,  0, issuedData->attrVals.valueRGB_B); 
    }
    ...
    if(0x01 == issuedData->attrFlags.flagAdd_Oxygen_Duration)
    {
        ...
        info->num++;
        dataPoints->valueAdd_Oxygen_Duration = gizX2Y(5,  1, issuedData->attrVals.valueAdd_Oxygen_Duration); 
    }
    ...
    if(0x01 == issuedData->attrFlags.flagFeed_Hour)
    {
        ...
        info->num++;
        dataPoints->valueFeed_Hour = gizX2Y(1,  0, issuedData->attrVals.valueFeed_Hour); 
    }
    ...
    if(0x01 == issuedData->attrFlags.flagFeed_Minute)
    {
        ...
        info->num++;
        dataPoints->valueFeed_Minute = gizX2Y(1,  0, issuedData->attrVals.valueFeed_Minute); 
    }
    ...
    if(0x01 == issuedData->attrFlags.flagFeed_Second)
    {
        ...
        info->num++;
        dataPoints->valueFeed_Second = gizX2Y(1,  0, issuedData->attrVals.valueFeed_Second); 
    }
    ...
    if(0x01 == issuedData->attrFlags.flagFeed_Interval)
    {
        ...
        info->num++;
        dataPoints->valueFeed_Interval = gizX2Y(1,  2, issuedData->attrVals.valueFeed_Interval); 
    }
    ...
    if(0x01 == issuedData->attrFlags.flagFeed_Count)
    {
        ...
        info->num++;
        dataPoints->valueFeed_Count = gizX2Y(1,  0, issuedData->attrVals.valueFeed_Count); 
    }
    ...
    if(0x01 == issuedData->attrFlags.flagTemperature_Max)
    {
        ...
        info->num++;
        dataPoints->valueTemperature_Max = gizX2YFloat(0.1,  -55, (float)(exchangeBytes(issuedData->attrVals.valueTemperature_Max)));
    }
    ...
    if(0x01 == issuedData->attrFlags.flagTemperature_Min)
    {
        ...
        info->num++;
        dataPoints->valueTemperature_Min = gizX2YFloat(0.1,  -55, (float)(exchangeBytes(issuedData->attrVals.valueTemperature_Min)));
    }
    ...
    if(0x01 == issuedData->attrFlags.flagAdd_Oxygen_Interval)
    {
        ...
        info->num++;
        dataPoints->valueAdd_Oxygen_Interval = gizX2Y(1,  1, exchangeBytes(issuedData->attrVals.valueAdd_Oxygen_Interval));
    }
    ...
    if(0x01 == issuedData->attrFlags.flagDefault_Water_Max)
    {
        ...
        info->num++;
        dataPoints->valueDefault_Water_Max = gizX2YFloat(0.1,  2, (float)(exchangeBytes(issuedData->attrVals.valueDefault_Water_Max)));
    }
    ...
    if(0x01 == issuedData->attrFlags.flagDefault_Water_Min)
    {
        ...
        info->num++;
        dataPoints->valueDefault_Water_Min = gizX2YFloat(0.1,  2, (float)(exchangeBytes(issuedData->attrVals.valueDefault_Water_Min)));
    }
...
static int8_t  gizCheckReport(dataPoint_t *cur, dataPoint_t *last)
{
    ...
    if(last->valueWater_level != cur->valueWater_level)
    {
        if(currentTime - lastReportTime >= 6000)
        {
            null_founction("valueWater_level Changed\r\n");
            ret = 1;
        }
    }
...
{
    if((0 == dataPoints) || (0 == devStatusPtr))
    {
        null_founction("gizDataPoints2ReportData Error , Illegal Param\r\n");
        return -1;
    }

    memset((uint8_t *)devStatusPtr->wBitBuf,0,sizeof(devStatusPtr->wBitBuf));
    memset((uint8_t *)devStatusPtr->alertBitBuf,0,sizeof(devStatusPtr->alertBitBuf));
    memset((uint8_t *)devStatusPtr->faultBitBuf,0,sizeof(devStatusPtr->faultBitBuf));

    gizStandardCompressValue(0,0,1,(uint8_t *)devStatusPtr,dataPoints->valueLed_Auto);
    gizStandardCompressValue(0,1,1,(uint8_t *)devStatusPtr,dataPoints->valueTemperature_Auto);
    gizStandardCompressValue(0,2,1,(uint8_t *)devStatusPtr,dataPoints->valueAdd_Temperature);
    gizStandardCompressValue(0,3,1,(uint8_t *)devStatusPtr,dataPoints->valueOxygen_Auto);
    gizStandardCompressValue(0,4,1,(uint8_t *)devStatusPtr,dataPoints->valueOxygen_Pump);
    gizStandardCompressValue(0,5,1,(uint8_t *)devStatusPtr,dataPoints->valueWater_Level_Auto);
    gizStandardCompressValue(0,6,1,(uint8_t *)devStatusPtr,dataPoints->valuePump);
    gizStandardCompressValue(0,7,1,(uint8_t *)devStatusPtr,dataPoints->valueFeed_Auto);
    if(dataPoints->valueServo >= Servo_VALUE_MAX)
    {
        null_founction("[ERROR] valueServo Error , Illegal Overstep\r\n");
        return -1;
    }
    else
    {
        gizStandardCompressValue(1,8,3,(uint8_t *)devStatusPtr,dataPoints->valueServo);  
    }
    gizStandardCompressValue(25,0,1,(uint8_t *)devStatusPtr,dataPoints->valueTemperature_Alarm);
    gizStandardCompressValue(25,1,1,(uint8_t *)devStatusPtr,dataPoints->valueWater_Level_Alarm);
    gizStandardCompressValue(26,0,1,(uint8_t *)devStatusPtr,dataPoints->valueDS18B20_Malfunction);
    gizStandardCompressValue(26,1,1,(uint8_t *)devStatusPtr,dataPoints->valueWater_Level_Malfunction);
    gizStandardCompressValue(26,2,1,(uint8_t *)devStatusPtr,dataPoints->valueFeed_Malfunction);
    ...
    devStatusPtr->valueRGB_R = gizY2X(1,  0, dataPoints->valueRGB_R); 
    devStatusPtr->valueRGB_G = gizY2X(1,  0, dataPoints->valueRGB_G); 
    devStatusPtr->valueRGB_B = gizY2X(1,  0, dataPoints->valueRGB_B); 
    devStatusPtr->valueAdd_Oxygen_Duration = gizY2X(5,  1, dataPoints->valueAdd_Oxygen_Duration); 
    devStatusPtr->valueFeed_Hour = gizY2X(1,  0, dataPoints->valueFeed_Hour); 
    devStatusPtr->valueFeed_Minute = gizY2X(1,  0, dataPoints->valueFeed_Minute); 
    devStatusPtr->valueFeed_Second = gizY2X(1,  0, dataPoints->valueFeed_Second); 
    devStatusPtr->valueFeed_Interval = gizY2X(1,  2, dataPoints->valueFeed_Interval); 
    devStatusPtr->valueFeed_Count = gizY2X(1,  0, dataPoints->valueFeed_Count); 

    devStatusPtr->valueTemperature_Max = exchangeBytes(gizY2XFloat(0.1,  -55, dataPoints->valueTemperature_Max));     
    devStatusPtr->valueTemperature_Min = exchangeBytes(gizY2XFloat(0.1,  -55, dataPoints->valueTemperature_Min));     
    devStatusPtr->valueAdd_Oxygen_Interval = exchangeBytes(gizY2X(1,  1, dataPoints->valueAdd_Oxygen_Interval)); 
    devStatusPtr->valueDefault_Water_Max = exchangeBytes(gizY2XFloat(0.1,  2, dataPoints->valueDefault_Water_Max));     
    devStatusPtr->valueDefault_Water_Min = exchangeBytes(gizY2XFloat(0.1,  2, dataPoints->valueDefault_Water_Min));     
    devStatusPtr->valueDS18B20 = exchangeBytes(gizY2XFloat(0.1,  -55, dataPoints->valueDS18B20));     
    devStatusPtr->valueWater_level = exchangeBytes(gizY2XFloat(0.01,  2, dataPoints->valueWater_level));     
...
static int8_t gizProtocolIssuedProcess(char *did, uint8_t *inData, uint32_t inLen, uint8_t *outData, uint32_t *outLen)
{
    ...
    if((0 == inData)||(0 == outData)||(0 == outLen))
    {
        null_founction("gizProtocolIssuedProcess Error , Illegal Param\r\n");
        return -1;
    }
...
{
    int32_t ret = 0;
    uint8_t tx_buf[((sizeof(devStatus_t)+sizeof(attrFlags_t)+20)*2)];
    uint32_t offset = 0;
    uint8_t sDidLen = 0;
    uint16_t data_len = 0;
    ...
    if(0 == gizdata)
    {
        null_founction("[ERR]  data Is Null \r\n");
        return -1;
    }
    ...
    null_founction("len = %d , sDidLen = %d ,data_len = %d\r\n", len,sDidLen,data_len);
    *pTxBuf ++= 0xFF;
    *pTxBuf ++= 0xFF;
    ...
    *pTxBuf ++= proFlag;
    ...
    if(ret < 0)
    {
        null_founction("uart write error %d \r\n", ret);
        return -2;
    }
...
static int32_t gizReportData(uint8_t action, uint8_t *gizdata, uint32_t len)
{
    ...
    if(0 == gizdata)
    {
        null_founction("gizReportData Error , Illegal Param\r\n");
        return -1;
    }
    ...
    if(ret < 0)
    {
        null_founction("ERR: uart write error %d \r\n", ret);
        return -2;
    }
...
static void gizDevReportPolicy(dataPoint_t *currentData)
{
    ...
    {
        null_founction("changed, report data\r\n");
    ...
    {
        null_founction("Info: 600S report data\r\n");
        if(0 == gizDataPoints2ReportData(currentData,&gizwitsProtocol.reportData.devStatus))
        {
            gizReportData(ACTION_REPORT_DEV_STATUS, (uint8_t *)&gizwitsProtocol.reportData.devStatus, sizeof(devStatus_t));
        }       
...
static int8_t gizProtocolGetOnePacket(rb_t *rb, uint8_t *gizdata, uint16_t *len)
{
    ...
    protocolHead_t *head = 0;

    if((0 == rb) || (0 == gizdata) ||(0 == len))
    {
        null_founction("gizProtocolGetOnePacket Error , Illegal Param\r\n");
        return -1;
    }
...
static int32_t gizProtocolCommonAck(protocolHead_t *head)
{
    ...
    if(0 == head)
    {
        null_founction("ERR: gizProtocolCommonAck data is empty \r\n");
        return -1;
    }
...
static void gizProtocolAckHandle(void)
{
    ...
    {
        if(2 > gizwitsProtocol.waitAck.num)
        {
            
            if(200 < (gizGetTimerCount() - gizwitsProtocol.waitAck.sendTime))
            {
                null_founction("Warning:gizProtocolResendData %d %d %d\r\n", gizGetTimerCount(), gizwitsProtocol.waitAck.sendTime, gizwitsProtocol.waitAck.num);
...
static int32_t gizProtocolGetDeviceInfo(protocolHead_t * head)
{
    ...
    if(0 == head)
    {
        null_founction("gizProtocolGetDeviceInfo Error , Illegal Param\r\n");
        return -1;
    }
    ...
    memcpy((uint8_t *)deviceInfo.protocolVer, "00000004", 8);
    memcpy((uint8_t *)deviceInfo.p0Ver, "00000002", 8);
    memcpy((uint8_t *)deviceInfo.softVer, "20210501", 8);
    memcpy((uint8_t *)deviceInfo.hardVer, "20210201", 8);
    memcpy((uint8_t *)deviceInfo.productKey, "6ae82ee2142a48cab88b03d793e328ea", strlen("6ae82ee2142a48cab88b03d793e328ea"));
    memcpy((uint8_t *)deviceInfo.productSecret, "094dad5fc64044a6bd600557f99f11d6", strlen("094dad5fc64044a6bd600557f99f11d6"));
    memset((uint8_t *)deviceInfo.devAttr, 0, 8);
    deviceInfo.devAttr[7] |= 0<<0;
    deviceInfo.devAttr[7] |= (0x01<<1);
    deviceInfo.ninableTime = exchangeBytes(0);
...
static int32_t gizProtocolErrorCmd(protocolHead_t *head,errorPacketsType_t errno)
{
    ...
    if(0 == head)
    {
        null_founction("gizProtocolErrorCmd Error , Illegal Param\r\n");
        return -1;
    }
...
{  
    ...
    if(0 == head)
    {
        null_founction("ERR: NTP is empty \r\n");
        return -1;
    }
...
static int8_t gizProtocolModuleStatus(protocolWifiStatus_t *status)
{
    ...
    if(0 == status)
    {
        null_founction("gizProtocolModuleStatus Error , Illegal Param\r\n");
        return -1;
    }
    ...
    if(lastStatus.types.onboarding != status->ststus.types.onboarding)
    {
        if(1 == status->ststus.types.onboarding)
        {
            if(1 == status->ststus.types.softap)
            {
                ...
                null_founction("OnBoarding: SoftAP or Web mode\r\n");
            }
            ...
            if(1 == status->ststus.types.station)
            {
                ...
                gizwitsProtocol.wifiStatusEvent.num++;
                null_founction("OnBoarding: AirLink mode\r\n");
            }
        }
        else
        {
            ...
            if(1 == status->ststus.types.station)
            {
                ...
                gizwitsProtocol.wifiStatusEvent.num++;
                null_founction("OnBoarding: Station mode\r\n");
            }
        }
    }
...
void gizwitsInit(void)
{    
    pRb.rbCapacity = ((sizeof(devStatus_t)+sizeof(attrFlags_t)+20)*2);
    pRb.rbBuff = rbBuf;
    if(0 == rbCreate(&pRb))
	{
		null_founction("rbCreate Success \r\n");
	}
	else
	{
		null_founction("rbCreate Faild \r\n");
	}
...
int32_t gizwitsSetMode(uint8_t mode)
{
    ...
    switch(mode)
    {
        ...
        case WIFI_REBOOT_MODE:
            ...
            break;
        default:
            null_founction("ERR: CfgMode error!\r\n");
            break;
    }
...
void gizwitsGetNTP(void)
{
    ...
    if(ret < 0)
    {
        null_founction("ERR[NTP]: uart write error %d \r\n", ret);
    }
...
int32_t gizwitsHandle(dataPoint_t *currentData) 
{
    ...
    uint8_t ackData[((sizeof(devStatus_t)+sizeof(attrFlags_t)+20)*2)];
    uint16_t protocolLen = 0;
    uint32_t ackLen = 0;
    protocolHead_t *recvHead = 0;
    char *didPtr = 0;
    uint16_t offset = 0;
    ...
    if(0 == currentData)
    {
        null_founction("GizwitsHandle Error , Illegal Param\r\n");
        return -1;
    }
    ...
    if(0 == ret)
    {
        null_founction("Get One Packet!\r\n");


        null_founction("WiFi2MCU[%4d:%4d]: ", gizGetTimerCount(), protocolLen);
        for(i=0; i<protocolLen;i++)
        {
            null_founction("%02x ", gizwitsProtocol.protocolBuf[i]);
        }
        null_founction("\r\n");
        ...
        switch (recvHead->cmd)
        {
            ...
            case CMD_MCU_REBOOT:
                gizProtocolCommonAck(recvHead);
                null_founction("report:MCU reboot!\r\n");
            ...
            case ACK_PRODUCTION_TEST:
                gizProtocolWaitAckCheck(recvHead);
                null_founction("Ack PRODUCTION_MODE success \r\n");
                break;           
            case ACK_GET_NTP:
                gizProtocolWaitAckCheck(recvHead);
                gizProtocolNTP(recvHead);

                null_founction("Ack GET_UTT success \r\n");
                break; 
            case ACK_ASK_MODULE_INFO:
                gizProtocolWaitAckCheck(recvHead);
                gizProtocolModuleInfoHandle(recvHead);
                null_founction("Ack GET_Module success \r\n");
            break;
 
            default:
                gizProtocolErrorCmd(recvHead,ERROR_CMD);
                null_founction("ERR: cmd code error!\r\n");
                break;
        }
    }
    else if(-2 == ret)
    {
        ...
        null_founction("ERR: check sum error!\r\n");
        return -2;
    }
...
{
	int32_t ret = 0;
	uint8_t tx_buf[(sizeof(devStatus_t)+sizeof(attrFlags_t)+20)];
	uint8_t *pTxBuf = tx_buf;
	uint16_t data_len = 6+len;
    if(0 == gizdata)
    {
        null_founction("[ERR] gizwitsPassthroughData Error \r\n");
        return (-1);
    }
	...
	*pTxBuf ++= 0x00;
	*pTxBuf ++= 0x00;
	*pTxBuf ++= ACTION_D2W_TRANSPARENT_DATA;
