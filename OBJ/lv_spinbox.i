#line 1 "..\\GUI\\lvgl_src\\lv_widgets\\lv_spinbox.c"
...
#line 1 "..\\GUI\\lvgl_src\\lv_widgets\\../lv_widgets/lv_textarea.h"
...
#line 17 "..\\GUI\\lvgl_src\\lv_widgets\\../lv_widgets/lv_textarea.h"
...
#line 30 "..\\GUI\\lvgl_src\\lv_widgets\\../lv_widgets/lv_textarea.h"
...
#line 31 "..\\GUI\\lvgl_src\\lv_widgets\\../lv_widgets/lv_textarea.h"
...
#line 32 "..\\GUI\\lvgl_src\\lv_widgets\\../lv_widgets/lv_textarea.h"
...
#line 74 "..\\GUI\\lvgl_src\\lv_widgets\\../lv_widgets/lv_textarea.h"
    uint8_t pwd_mode : 1;  
    uint8_t one_line : 1;  
} lv_textarea_ext_t;
...
#line 10 "..\\GUI\\lvgl_src\\lv_widgets\\lv_spinbox.c"

#line 13 "..\\GUI\\lvgl_src\\lv_widgets\\lv_spinbox.c"
...
#line 14 "..\\GUI\\lvgl_src\\lv_widgets\\lv_spinbox.c"
#line 15 "..\\GUI\\lvgl_src\\lv_widgets\\lv_spinbox.c"
#line 1 "..\\GUI\\lvgl_src\\lv_widgets\\../lv_misc/lv_utils.h"
...
#line 17 "..\\GUI\\lvgl_src\\lv_widgets\\../lv_misc/lv_utils.h"
#line 18 "..\\GUI\\lvgl_src\\lv_widgets\\../lv_misc/lv_utils.h"
...
#line 16 "..\\GUI\\lvgl_src\\lv_widgets\\lv_spinbox.c"
...
lv_obj_t * lv_spinbox_create(lv_obj_t * par, const lv_obj_t * copy)
{
    ...
    do { if(!((lv_debug_check_null(spinbox)))) { ; lv_debug_log_error("Out of memory", (uint64_t)((uintptr_t)spinbox)); while(1); } } while(0);;
    ...
    if(ancestor_signal == 0) ancestor_signal = lv_obj_get_signal_cb(spinbox);
    if(ancestor_design == 0) ancestor_design = lv_obj_get_design_cb(spinbox);
    ...
    lv_obj_set_design_cb(spinbox, ancestor_design);  

     
    if(copy == 0) {
        
 
        lv_obj_set_click(lv_page_get_scrollable(spinbox), 0);
        lv_textarea_set_one_line(spinbox, 1);
        lv_textarea_set_cursor_click_pos(spinbox, 1);
        ...
        lv_obj_refresh_style(spinbox, LV_OBJ_PART_ALL, 0xFF);
    }
...
void lv_spinbox_set_rollover(lv_obj_t * spinbox, _Bool b)
{
    do { if(!((lv_debug_check_null(spinbox)))) { ; lv_debug_log_error("NULL pointer", (uint64_t)((uintptr_t)spinbox)); while(1); } } while(0);;
...
void lv_spinbox_set_digit_format(lv_obj_t * spinbox, uint8_t digit_count, uint8_t separator_position)
{
    ...
    if(digit_count > 10) digit_count = 10;

    if(separator_position >= digit_count) separator_position = 0;
    if(separator_position > 10) separator_position = 10;
...
void lv_spinbox_step_prev(lv_obj_t * spinbox)
{
    ...
    lv_spinbox_ext_t * ext = lv_obj_get_ext_attr(spinbox);
    int32_t step_limit;
    step_limit       = ((ext->range_max) > ((ext->range_min < 0 ? (-ext->range_min) : ext->range_min)) ? (ext->range_max) : ((ext->range_min < 0 ? (-ext->range_min) : ext->range_min)));
    int32_t new_step = ext->step * 10;
...
static lv_res_t lv_spinbox_signal(lv_obj_t * spinbox, lv_signal_t sign, void * param)
{
    ...
    if(sign == LV_SIGNAL_GET_TYPE) return lv_obj_handle_get_type_signal(param, "lv_spinbox");
...
static lv_style_list_t * lv_spinbox_get_style(lv_obj_t * ta, uint8_t part)
{
    do { if(!((lv_debug_check_null(ta)))) { ; lv_debug_log_error("NULL pointer", (uint64_t)((uintptr_t)ta)); while(1); } } while(0);;
