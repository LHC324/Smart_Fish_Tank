...
#define OPEN_DEBUG_WIFI  0	//是否打开wifi调试串口（1：普通模式；2：DMA）
int null_founction(const char *format, ...); //模拟空的printf函数
...
* @{
*/
#if (OPEN_DEBUG_WIFI == 1)
#define GIZWITS_LOG printf           //使用普通串口中断
#elif (OPEN_DEBUG_WIFI == 2)
#define GIZWITS_LOG Usart1_DmaPrintf //使用DMA
#else
#define GIZWITS_LOG null_founction //定义一个空的输出函数
#endif
