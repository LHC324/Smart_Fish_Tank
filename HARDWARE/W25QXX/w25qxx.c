...
//2^24=16M,2^32=4G，256的寄存器有3个，128及以下只有1个	
//有个大坑https://wenku.baidu.com/view/e82087157ed5360cba1aa8114431b90d6c8589b7.html#
...
{  
	u8 byte=0;   
	W25QXX_CS=0;                            //使能器件   
	SPI_ReadWriteByte(W25X_ReadStatusReg1);    //发送读取状态寄存器命令    
...
{   
	W25QXX_CS=0;                            //使能器件   
	SPI_ReadWriteByte(W25X_ReadStatusReg1);   //发送写取状态寄存器命令    
