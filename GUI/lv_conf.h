...
#define LV_HOR_RES_MAX          (320) //屏幕显示的水平分辨率
#define LV_VER_RES_MAX          (240) //屏幕显示器的垂直分辨率
...
#define LV_COLOR_16_SWAP   0 //颜色高低位交换
...
#define LV_COLOR_TRANSP    LV_COLOR_LIME         /*LV_COLOR_LIME: pure green透明的铬键图像*/

/* Enable anti-aliasing (lines, and radiuses will be smoothed) */
#define LV_ANTIALIAS        1 //抗锯齿
...
#define LV_MEM_CUSTOM      1 //使用FreeRTOS分配内存
#if LV_MEM_CUSTOM == 0
/* Size of the memory used by `lv_mem_alloc` in bytes (>= 2kB)*/
#  define LV_MEM_SIZE    (30U * 1024U) //24K
...
#define LV_USE_GPU              0   /*Only enables `gpu_fill_cb` and `gpu_blend_cb` in the disp. drv-不使用GPU*/
...
#define LV_USE_API_EXTENSION_V6  0 //禁用V6版API
...
#define LV_THEME_DEFAULT_COLOR_PRIMARY      LV_COLOR_RED//lv_color_hex(0x01a2b1) //主色调，支持自主配色
#define LV_THEME_DEFAULT_COLOR_SECONDARY    LV_COLOR_BLUE//lv_color_hex(0x44d1b6) //次色调，支持自主配色
